...
describe("@raikou/core/Notification", () => {
  ...
  it("renders close button based on withCloseButton prop", () => {
    ...
    expect(
      container.querySelector(".raikou-Notification-closeButton")
  ...
  it("renders given icon", () => {
    ...
    expect(
      container.querySelector(".raikou-Notification-icon")
    ).toHaveTextContent("test-icon");
  ...
  it("displays loader when loading prop is true", () => {
    ...
    expect(
      container.querySelector(".raikou-Notification-loader")
    ).toBeInTheDocument();
  ...
  it("renders given title", () => {
    ...
    expect(
      container.querySelector(".raikou-Notification-title")
