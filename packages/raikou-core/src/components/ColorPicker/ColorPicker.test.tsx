...
describe("@raikou/core/ColorPicker", () => {
  ...
  it("renders swatches based on swatches prop", () => {
    ...
    expect(
      container.querySelector(".raikou-ColorPicker-swatches")
    ).toBeInTheDocument();
  ...
  it("renders picker based on withPicker prop", () => {
    ...
    expect(
      container.querySelector(".raikou-ColorPicker-saturation")
    ).toBeInTheDocument();
  ...
  it("calls onChangeEnd when swatch is clicked", async () => {
    ...
    await userEvent.click(
      container.querySelectorAll(".raikou-ColorSwatch-root")[0]
    );
