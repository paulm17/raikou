...
import {
  ComboboxOption,
  ComboboxOptionProps,
  ComboboxOptionStylesNames,
} from "./ComboboxOption";

const TestContainer = createContextContainer(ComboboxOption, Combobox, {
  withinPortal: false,
});
...
describe("@raikou/core/ComboboxOption", () => {
  tests.itSupportsSystemProps<ComboboxOptionProps, ComboboxOptionStylesNames>({
    ...
    displayName: "@raikou/core/ComboboxOption",
    stylesApiSelectors: ["option"],
    stylesApiName: "Combobox",
    selector: ".raikou-Combobox-option",
    compound: true,
