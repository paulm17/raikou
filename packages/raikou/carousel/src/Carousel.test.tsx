...
describe("@raikou/core/Carousel", () => {
  tests.itSupportsSystemProps<CarouselProps, CarouselStylesNames>({
    ...
    displayName: "@raikou/core/Carousel",
    stylesApiSelectors: [
      "root",
      "container",
      "control",
  ...
  it("renders controls if withControls is true", () => {
    ...
    expect(
      container.querySelector(".raikou-Carousel-controls"),
    ).toBeInTheDocument();
  });
  ...
  it("renders indicators if withIndicators is true", () => {
    ...
    expect(
      container.querySelector(".raikou-Carousel-indicators"),
    ).toBeInTheDocument();
  });
  ...
  it("supports custom next/previous controls icons", () => {
    render(
      <Carousel
        nextControlIcon="Next icon"
        previousControlIcon="Previous icon"
      />,
    );
