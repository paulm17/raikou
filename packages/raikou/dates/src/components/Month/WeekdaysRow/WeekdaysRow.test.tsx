...
describe("@raikou/dates/WeekdaysRow", () => {
  ...
  it("supports styles api (styles)", () => {
    render(
      <Wrapper
        styles={{
          weekday: { borderColor: "#CECECE" },
          weekdaysRow: { borderColor: "#FFEECD" },
        }}
      />,
    );
    expect(screen.getAllByRole("columnheader")[0]).toHaveStyle({
      borderColor: "#CECECE",
    });
  ...
  it("supports styles api (classNames)", () => {
    render(
      <Wrapper
        classNames={{
          weekday: "test-weekday-class",
          weekdaysRow: "test-weekdays-row-class",
        }}
      />,
    );
