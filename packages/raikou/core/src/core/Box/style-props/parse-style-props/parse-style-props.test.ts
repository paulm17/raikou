...
describe("@raikou/core/Box/parse-style-props", () => {
  it("parses non responsive style props correctly", () => {
    expect(
      ...
      inlineStyles: {
        padding: "calc(1.5rem * var(--raikou-scale))",
        marginLeft: "calc(2rem * var(--raikou-scale))",
        marginRight: "calc(2rem * var(--raikou-scale))",
        color: "var(--raikou-color-red-5)",
        opacity: 0.65,
      },
      styles: {},
      media: [],
      ...
      media: [
        {
          ...
          styles: {
            padding: "calc(2rem * var(--raikou-scale))",
            marginLeft: "calc(4rem * var(--raikou-scale))",
            marginRight: "calc(4rem * var(--raikou-scale))",
    ...
    expect(
      ...
      media: [
        ...
        },
        {
          ...
          styles: {
            padding: "calc(3rem * var(--raikou-scale))",
            marginLeft: "calc(8rem * var(--raikou-scale))",
            marginRight: "calc(8rem * var(--raikou-scale))",
            color: "var(--raikou-color-red-7)",
            opacity: 1,
          },
        },
      ],
