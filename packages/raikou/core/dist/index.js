...
var loadConfig=()=>{let config;const appPath=require("path").resolve("./");try{config=require(`${appPath}/raikou_theme.ts`);}catch(error){if(error.code!=="MODULE_NOT_FOUND"){throw new Error("raikou_theme.ts file found.");}}
