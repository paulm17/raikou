...
import React11, { useCallback as useCallback14, useRef as useRef27, useState as useState34 } from "react";
...
function Marks({
  ...
  const items = marks.map((mark, index) => /* @__PURE__ */ React7.createElement(
    Box,
    ...
    mark.label && /* @__PURE__ */ React7.createElement("div", __spreadValues({}, getStyles("markLabel")), mark.label)
  ));
  return /* @__PURE__ */ React7.createElement("div", null, items);
}
...
function Track(_a) {
  ...
  return /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement(
    ...
    /* @__PURE__ */ React8.createElement(Box, __spreadProps(__spreadValues({}, getStyles("track")), { mod: { inverted, disabled } }), /* @__PURE__ */ React8.createElement(
      Box,
      __spreadValues({
    ...
    ), children, /* @__PURE__ */ React8.createElement(
      Marks,
...
// src/Thumb/Thumb.tsx
import React10, { useState as useState33, forwardRef as forwardRef5 } from "react";
  ...
  ({
    ...
    return /* @__PURE__ */ React10.createElement(
      ...
      /* @__PURE__ */ React10.createElement(
        ...
        (transitionStyles) => /* @__PURE__ */ React10.createElement("div", __spreadValues({}, getStyles("label", { style: transitionStyles })), label)
      )
    );
  }
);
...
var Slider = factory((_props, ref) => {
  ...
  const valueRef = useRef27(_value);
  const root = useRef27();
  const thumb = useRef27();
  ...
  return /* @__PURE__ */ React11.createElement(SliderProvider, { value: { getStyles } }, /* @__PURE__ */ React11.createElement(
    SliderRoot,
    __spreadProps(__spreadValues({}, others), {
    ...
    /* @__PURE__ */ React11.createElement("input", { type: "hidden", name, value: scaledValue })
  ));
});
Slider.displayName = "@raikou/core/Slider";

// src/RangeSlider/RangeSlider.tsx
import React12, { useEffect as useEffect35, useRef as useRef28, useState as useState35 } from "react";
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = useState35(-1);
  ...
  const valueRef = useRef28(_value);
  const thumbs = useRef28([]);
  const thumbIndex = useRef28(void 0);
  const positions = [
  ...
  return /* @__PURE__ */ React12.createElement(SliderProvider, { value: { getStyles } }, /* @__PURE__ */ React12.createElement(SliderRoot, __spreadProps(__spreadValues({}, others), { size, ref, disabled }), /* @__PURE__ */ React12.createElement(
    Track,
    {
      offset: positions[0],
  ...
  ), /* @__PURE__ */ React12.createElement("input", { type: "hidden", name: `${name}_from`, value: _value[0] }), /* @__PURE__ */ React12.createElement("input", { type: "hidden", name: `${name}_to`, value: _value[1] })));
});
