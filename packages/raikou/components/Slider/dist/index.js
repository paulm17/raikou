...
// src/SliderRoot/SliderRoot.tsx
var SliderRoot = (0, import_react62.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
      size,
      disabled,
...
function Marks({
  ...
  const items = marks.map((mark, index) => /* @__PURE__ */ import_react63.default.createElement(
    Box,
    ...
    mark.label && /* @__PURE__ */ import_react63.default.createElement("div", __spreadValues({}, getStyles("markLabel")), mark.label)
  ));
  return /* @__PURE__ */ import_react63.default.createElement("div", null, items);
}
...
function Track(_a) {
  ...
  return /* @__PURE__ */ import_react64.default.createElement(import_react64.default.Fragment, null, /* @__PURE__ */ import_react64.default.createElement(
    ...
    /* @__PURE__ */ import_react64.default.createElement(Box, __spreadProps(__spreadValues({}, getStyles("track")), { mod: { inverted, disabled } }), /* @__PURE__ */ import_react64.default.createElement(
      Box,
      __spreadValues({
...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react65.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react65.useState)(
    mounted ? "entered" : "exited"
  );
  const timeoutRef = (0, import_react65.useRef)(-1);
  ...
  (0, import_react65.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, null, children(
    getTransitionStyles({
      transition,
...
// src/Thumb/Thumb.tsx
var Thumb = (0, import_react67.forwardRef)(
  ({
    max,
    min,
    value,
    ...
    const { getStyles } = useSliderContext();
    const [focused, setFocused] = (0, import_react67.useState)(false);
    ...
    return /* @__PURE__ */ import_react67.default.createElement(
      ...
      /* @__PURE__ */ import_react67.default.createElement(
        ...
        (transitionStyles) => /* @__PURE__ */ import_react67.default.createElement("div", __spreadValues({}, getStyles("label", { style: transitionStyles })), label)
      )
    );
  }
);
...
var Slider = factory((_props, ref) => {
  ...
  const [hovered, setHovered] = (0, import_react68.useState)(false);
  ...
  const valueRef = (0, import_react68.useRef)(_value);
  const root = (0, import_react68.useRef)();
  const thumb = (0, import_react68.useRef)();
  ...
  return /* @__PURE__ */ import_react68.default.createElement(SliderProvider, { value: { getStyles } }, /* @__PURE__ */ import_react68.default.createElement(
    SliderRoot,
    __spreadProps(__spreadValues({}, others), {
    ...
    /* @__PURE__ */ import_react68.default.createElement("input", { type: "hidden", name, value: scaledValue })
  ));
});
...
var RangeSlider = factory((_props, ref) => {
  const props = useProps("RangeSlider", defaultProps2, _props);
  const _a = props, {
    classNames,
    styles,
    value,
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react69.useState)(-1);
  const [hovered, setHovered] = (0, import_react69.useState)(false);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [min, max],
  ...
  const valueRef = (0, import_react69.useRef)(_value);
  const thumbs = (0, import_react69.useRef)([]);
  const thumbIndex = (0, import_react69.useRef)(void 0);
  const positions = [
  ...
  return /* @__PURE__ */ import_react69.default.createElement(SliderProvider, { value: { getStyles } }, /* @__PURE__ */ import_react69.default.createElement(SliderRoot, __spreadProps(__spreadValues({}, others), { size, ref, disabled }), /* @__PURE__ */ import_react69.default.createElement(
    Track,
    {
      offset: positions[0],
  ...
  ), /* @__PURE__ */ import_react69.default.createElement("input", { type: "hidden", name: `${name}_from`, value: _value[0] }), /* @__PURE__ */ import_react69.default.createElement("input", { type: "hidden", name: `${name}_to`, value: _value[1] })));
});
