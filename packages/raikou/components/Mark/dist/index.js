...
function getMarkColor({
  ...
  const parsed = (0, import_core.parseThemeColor)({ color, theme });
...
var varsResolver = (0, import_core2.createVarsResolver)((theme, { color }) => ({
  root: {
    "--mark-bg-dark": getMarkColor({ color, theme, defaultShade: 5 }),
    "--mark-bg-light": getMarkColor({ color, theme, defaultShade: 2 })
  }
}));
var Mark = (0, import_core2.factory)((_props, ref) => {
  const props = (0, import_core2.useProps)("Mark", defaultProps, _props);
  const _a = props, {
    classNames,
    className,
    style,
