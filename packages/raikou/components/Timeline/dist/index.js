...
var TimelineItem = (0, import_core.factory)((_props, ref) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    /* @__PURE__ */ import_react.default.createElement("div", __spreadValues({}, useStore.getState().getStyles("itemBody", stylesApiProps)), title && /* @__PURE__ */ import_react.default.createElement("div", __spreadValues({}, useStore.getState().getStyles("itemTitle", stylesApiProps)), title), /* @__PURE__ */ import_react.default.createElement("div", __spreadValues({}, useStore.getState().getStyles("itemContent", stylesApiProps)), children))
  );
});
