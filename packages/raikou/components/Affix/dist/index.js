...
function getStyle({
  ...
  return {
    ...
    ...resolveVars({ theme, props, stylesCtx, vars, varsResolver: varsResolver2, selector, themeName }),
...
var Portal = (0, import_react60.forwardRef)((props, ref) => {
  ...
  return (0, import_react_dom.createPortal)(
    /* @__PURE__ */ import_react60.default.createElement("div", { className, ref, ...others }, children),
    nodeRef.current
  );
});
...
function OptionalPortal({
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react61.default.createElement(Portal, { ...others }, children);
  }
...
var Affix = factory((_props, ref) => {
  const props = useProps("Affix", defaultProps2, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react62.default.createElement(OptionalPortal, { ...portalProps, withinPortal }, /* @__PURE__ */ import_react62.default.createElement(Box, { ref, ...getStyles("root"), ...others }));
});
