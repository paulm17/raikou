...
var Portal = forwardRef4((props, ref) => {
  ...
  return createPortal(
    /* @__PURE__ */ React5.createElement("div", { className, ref, ...others }, children),
    nodeRef.current
  );
});
...
function OptionalPortal({
  ...
  if (withinPortal) {
    return /* @__PURE__ */ React6.createElement(Portal, { ...others }, children);
  }
...
var Affix = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React7.createElement(OptionalPortal, { ...portalProps, withinPortal }, /* @__PURE__ */ React7.createElement(Box, { ref, ...getStyles("root"), ...others }));
});
