...
import { findElementAncestor, GetStylesApi } from "@raikou/core";
...
export function TreeNode({
  ...
  const handleKeyDown = (event: React.KeyboardEvent) => {
    ...
    if (
      ...
      const root = findElementAncestor(
        event.currentTarget as HTMLElement,
        "[data-tree-root]",
      );
      ...
      const nextIndex =
        event.nativeEvent.code === "ArrowDown" ? index + 1 : index - 1;
...
TreeNode.displayName = "@raikou/core/TreeNode";
