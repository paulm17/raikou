...
function useProps(component, defaultProps7, props) {
  ...
  return __spreadValues(__spreadValues(__spreadValues({}, defaultProps7), contextProps), filterProps(props));
}
...
// src/InputPlaceholder/InputPlaceholder.tsx
...
// src/InputWrapper/get-input-offsets/get-input-offsets.ts
...
// src/use-input-props.ts
function useInputProps(component, defaultProps7, _props) {
  const props = useProps(component, defaultProps7, _props);
  const _a = props, {
    label,
    description,
    error,
