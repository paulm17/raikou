...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react16.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react16.useState)(
    mounted ? "entered" : "exited"
  );
  const timeoutRef = (0, import_react16.useRef)(-1);
  ...
  (0, import_react16.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react17.default.createElement(import_react17.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react17.default.createElement(import_react17.default.Fragment, null, children(
    getTransitionStyles({
      transition,
...
function FocusTrap({
  ...
  return (0, import_react18.cloneElement)(children, { [refProp]: ref });
}
...
// src/ModalBaseOverlay.tsx
var ModalBaseOverlay = (0, import_react23.forwardRef)((_a, ref) => {
  var _b = _a, { onClick, transitionProps, style } = _b, others = __objRest(_b, ["onClick", "transitionProps", "style"]);
  const ctx = useModalBaseContext();
  const transition = useModalTransition(transitionProps);
  return /* @__PURE__ */ import_react23.default.createElement(Transition, __spreadProps(__spreadValues({ mounted: ctx.opened }, transition), { transition: "fade" }), (transitionStyles) => /* @__PURE__ */ import_react23.default.createElement(
    Overlay,
    __spreadValues({
      ref,
      fixed: true,
...
// src/ModalBaseTitle.tsx
var ModalBaseTitle = (0, import_react25.forwardRef)((_a, ref) => {
  var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
