...
function useProps(component, defaultProps17, props) {
  var _a;
  const theme = DEFAULT_THEME;
  const contextPropsPayload = (_a = theme.components[component]) == null ? void 0 : _a.defaultProps;
  const contextProps = typeof contextPropsPayload === "function" ? contextPropsPayload(theme) : contextPropsPayload;
  return __spreadValues(__spreadValues(__spreadValues({}, defaultProps17), contextProps), filterProps(props));
}
...
function resolveVars({
  ...
  var _a;
  return (_a = mergeVars([
    varsResolver7 == null ? void 0 : varsResolver7(theme, props, stylesCtx),
    ...themeName.map((name) => {
      var _a2, _b, _c;
...
function getStyle({
  ...
  return __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, getThemeStyles({ theme, themeName, props, stylesCtx, selector })), resolveStyles({ theme, styles, props, stylesCtx })[selector]), resolveStyles({ theme, styles: options == null ? void 0 : options.styles, props: (options == null ? void 0 : options.props) || props, stylesCtx })[selector]), resolveVars({ theme, props, stylesCtx, vars, varsResolver: varsResolver7, selector, themeName })), rootSelector === selector ? resolveStyle({ style, theme }) : null), resolveStyle({ style: options == null ? void 0 : options.style, theme }));
}
function useStyles({
  name,
  classes,
...
var SideCar = function(_a) {
  ...
  return React4.createElement(Target, (0, import_tslib2.__assign)({}, rest));
};
...
var RemoveScroll = React5.forwardRef(function(props, parentRef) {
  ...
  return React5.createElement(
    ...
    forwardProps ? React5.cloneElement(React5.Children.only(children), (0, import_tslib3.__assign)((0, import_tslib3.__assign)({}, containerProps), { ref: containerRef })) : React5.createElement(Container, (0, import_tslib3.__assign)({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var ReactRemoveScroll = React9.forwardRef(function(props, ref) {
  return React9.createElement(RemoveScroll, (0, import_tslib5.__assign)({}, props, { ref, sideCar: sidecar_default }));
});
...
// ../Portal/src/Portal.tsx
var defaultProps = {};
var Portal = (0, import_react61.forwardRef)((props, ref) => {
  const _a = useProps(
    "Portal",
    defaultProps,
    props
  ...
  return (0, import_react_dom.createPortal)(
    /* @__PURE__ */ import_react61.default.createElement("div", __spreadValues({ className, ref }, others), children),
    nodeRef.current
  );
});
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react62.default.createElement(Portal, __spreadValues({}, others), children);
  }
...
function createSafeContext(errorMessage) {
  const Context = (0, import_react63.createContext)(null);
  const useSafeContext = () => {
    const ctx = (0, import_react63.useContext)(Context);
    if (ctx === null) {
...
function useLockScroll({ opened, transitionDuration }) {
  const [shouldLockScroll, setShouldLockScroll] = (0, import_react65.useState)(opened);
  const timeout = (0, import_react65.useRef)();
...
function useModal({
  ...
  const _id = useId(id);
  const [titleMounted, setTitleMounted] = (0, import_react66.useState)(false);
...
// ../ModalBase/src/ModalBase.tsx
var ModalBase = (0, import_react67.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
      keepMounted,
      opened,
    ...
    return /* @__PURE__ */ import_react67.default.createElement(OptionalPortal, __spreadProps(__spreadValues({}, portalProps), { withinPortal }), /* @__PURE__ */ import_react67.default.createElement(
      ModalBaseProvider,
      {
        value: {
          opened,
      ...
      /* @__PURE__ */ import_react67.default.createElement(Combination_default, { enabled: shouldLockScroll && lockScroll }, /* @__PURE__ */ import_react67.default.createElement(
        Box,
...
// ../ModalBase/src/ModalBaseBody.tsx
var ModalBaseBody = (0, import_react69.forwardRef)(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ import_react69.default.createElement(
      ...
      __spreadProps(__spreadValues({
        ...
        id: bodyId,
        className: clsx_m_default2("modalBase-body", className)
      })
    );
  }
);
...
var CloseIcon = (0, import_react70.forwardRef)(
  (_a, ref) => {
...
var Bars = (0, import_react72.forwardRef)(
  (_a, ref) => {
    var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
    return /* @__PURE__ */ import_react72.default.createElement(
      ...
      __spreadProps(__spreadValues({
        component: "span",
        className: clsx_m_default2("bars-loader", className)
      }, others), {
        ref
      }),
      /* @__PURE__ */ import_react72.default.createElement("span", { className: "bar" }),
      /* @__PURE__ */ import_react72.default.createElement("span", { className: "bar" }),
      /* @__PURE__ */ import_react72.default.createElement("span", { className: "bar" })
    );
  }
...
var Oval = (0, import_react73.forwardRef)(
  (_a, ref) => {
    var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
    return /* @__PURE__ */ import_react73.default.createElement(
      ...
      __spreadProps(__spreadValues({
        component: "span",
        className: clsx_m_default2("oval-loader", className)
      }, others), {
        ref
      })
    );
...
var Dots = (0, import_react74.forwardRef)(
  (_a, ref) => {
    var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
    return /* @__PURE__ */ import_react74.default.createElement(
      ...
      __spreadProps(__spreadValues({
        component: "span",
        className: clsx_m_default2("dots-loader", className)
      }, others), {
        ref
      }),
      /* @__PURE__ */ import_react74.default.createElement("span", { className: "dot" }),
      /* @__PURE__ */ import_react74.default.createElement("span", { className: "dot" }),
      /* @__PURE__ */ import_react74.default.createElement("span", { className: "dot" }),
      /* @__PURE__ */ import_react74.default.createElement("span", { className: "dot" }),
      /* @__PURE__ */ import_react74.default.createElement("span", { className: "dot" }),
...
var ActionIcon = polymorphicFactory(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ import_react77.default.createElement(
      ...
      loading ? /* @__PURE__ */ import_react77.default.createElement(
        Loader,
...
var CloseButton = polymorphicFactory(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ import_react78.default.createElement(
      ...
      /* @__PURE__ */ import_react78.default.createElement(CloseIcon, null),
      children
    );
  }
);
...
// ../ModalBase/src/ModalBaseCloseButton.tsx
var ModalBaseCloseButton = (0, import_react79.forwardRef)((_a, ref) => {
  var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
  const ctx = useModalBaseContext();
  return /* @__PURE__ */ import_react79.default.createElement(
    ...
    __spreadProps(__spreadValues({
      ...
      onClick: ctx.onClose,
      className: clsx_m_default2("modalBase-close", className)
    })
  );
});
...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react80.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react80.useState)(
    mounted ? "entered" : "exited"
  );
  const timeoutRef = (0, import_react80.useRef)(-1);
  ...
  (0, import_react80.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react81.default.createElement(import_react81.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react81.default.createElement(import_react81.default.Fragment, null, children(
    getTransitionStyles({
      transition,
...
function FocusTrap({
  ...
  return (0, import_react82.cloneElement)(children, { [refProp]: ref });
}
...
// ../ModalBase/src/ModalBaseContent.tsx
var ModalBaseContent = (0, import_react84.forwardRef)(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ import_react84.default.createElement(
      ...
      (transitionStyles) => /* @__PURE__ */ import_react84.default.createElement(
        "div",
        __spreadProps(__spreadValues({}, innerProps), {
          className: clsx_m_default2("modalBase-inner", innerProps.className)
        }),
        /* @__PURE__ */ import_react84.default.createElement(FocusTrap, { active: ctx.opened && ctx.trapFocus }, /* @__PURE__ */ import_react84.default.createElement(
          Paper,
          __spreadProps(__spreadValues({}, others), {
            ...
            className: clsx_m_default2("modalBase-content", className)
          }),
          others.children
        ))
      )
...
var ModalBaseHeader = (0, import_react85.forwardRef)(
  (_a, ref) => {
    var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
    return /* @__PURE__ */ import_react85.default.createElement(Box, __spreadValues({ ref, className: clsx_m_default2("modalBase-header", className) }, others));
  }
);
...
var Overlay = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ import_react86.default.createElement(Box, __spreadValues(__spreadProps(__spreadValues({ ref }, getStyles2("root")), { mod: { center, fixed } }), others), children);
});
...
// ../ModalBase/src/ModalBaseOverlay.tsx
var ModalBaseOverlay = (0, import_react87.forwardRef)((_a, ref) => {
  var _b = _a, { onClick, transitionProps, style } = _b, others = __objRest(_b, ["onClick", "transitionProps", "style"]);
  const ctx = useModalBaseContext();
  const transition = useModalTransition(transitionProps);
  return /* @__PURE__ */ import_react87.default.createElement(Transition, __spreadProps(__spreadValues({ mounted: ctx.opened }, transition), { transition: "fade" }), (transitionStyles) => /* @__PURE__ */ import_react87.default.createElement(
    Overlay,
    __spreadValues({
      ref,
      fixed: true,
...
// ../ModalBase/src/ModalBaseTitle.tsx
var ModalBaseTitle = (0, import_react89.forwardRef)((_a, ref) => {
  var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
  ...
  return /* @__PURE__ */ import_react89.default.createElement(
    ...
    __spreadProps(__spreadValues({
      component: "h2",
      ref,
      className: clsx_m_default2("modalBase-title", className)
    }, others), {
      id
    })
  );
...
var ModalRoot = factory((_props, ref) => {
  const props = useProps("ModalRoot", defaultProps9, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react91.default.createElement(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2 } }, /* @__PURE__ */ import_react91.default.createElement(
    ModalBase,
    __spreadValues(__spreadProps(__spreadValues({
      ref
    }, getStyles2("root")), {
...
var ModalBody = factory((_props, ref) => {
  const props = useProps("ModalBody", defaultProps10, _props);
...
var defaultProps11 = {};
var ModalCloseButton = factory(
  (_props, ref) => {
    const props = useProps("ModalCloseButton", defaultProps11, _props);
    const _a = props, { classNames, className, style, styles, unstyled, vars } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "unstyled", "vars"]);
    const ctx = useModalContext();
...
var ModalOverlay = factory((_props, ref) => {
  const props = useProps("ModalOverlay", defaultProps12, _props);
  const _a = props, { classNames, className, style, styles, unstyled, vars } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "unstyled", "vars"]);
  const ctx = useModalContext();
...
var ModalContent = factory((_props, ref) => {
  const props = useProps("ModalContent", defaultProps13, _props);
  ...
  return /* @__PURE__ */ import_react95.default.createElement(
    ...
    /* @__PURE__ */ import_react95.default.createElement(Scroll, { style: { maxHeight: `calc(100vh - (${rem(ctx.yOffset)} * 2))` } }, children)
  );
});
...
var ModalTitle = factory((_props, ref) => {
  const props = useProps("ModalTitle", defaultProps14, _props);
  const _a = props, { classNames, className, style, styles, unstyled, vars } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "unstyled", "vars"]);
  const ctx = useModalContext();
...
var ModalHeader = factory((_props, ref) => {
  const props = useProps("ModalHeader", defaultProps15, _props);
  const _a = props, { classNames, className, style, styles, unstyled, vars } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "unstyled", "vars"]);
  const ctx = useModalContext();
...
var Modal = factory((_props, ref) => {
  const _a = useProps("Modal", defaultProps16, _props), {
    title,
    withOverlay,
    overlayProps,
    withCloseButton,
  ...
  return /* @__PURE__ */ import_react98.default.createElement(ModalRoot, __spreadValues({ ref }, others), withOverlay && /* @__PURE__ */ import_react98.default.createElement(ModalOverlay, __spreadValues({}, overlayProps)), /* @__PURE__ */ import_react98.default.createElement(ModalContent, null, hasHeader && /* @__PURE__ */ import_react98.default.createElement(ModalHeader, null, title && /* @__PURE__ */ import_react98.default.createElement(ModalTitle, null, title), withCloseButton && /* @__PURE__ */ import_react98.default.createElement(ModalCloseButton, __spreadValues({}, closeButtonProps))), /* @__PURE__ */ import_react98.default.createElement(ModalBody, null, children)));
});
