...
var MenuDropdown = (0, import_core13.factory)((props, ref) => {
  const _a = (0, import_core13.useProps)("MenuDropdown", defaultProps6, props), {
    classNames,
    className,
    style,
    styles,
  ...
  const handleMouseEnter = (0, import_core13.createEventHandler)(
    onMouseEnter,
    () => ctx.trigger === "hover" && ctx.openDropdown()
  );
  const handleMouseLeave = (0, import_core13.createEventHandler)(
    onMouseLeave,
...
var UnstyledButton = (0, import_core14.polymorphicFactory)(
  (_props, ref) => {
    const props = (0, import_core14.useProps)("UnstyledButton", defaultProps7, _props);
    const _a = props, {
      className,
      component = "button",
      __staticSelector,
...
// src/MenuItem/MenuItem.tsx
var defaultProps8 = {};
var MenuItem = (0, import_core15.polymorphicFactory)((props, ref) => {
  const _a = (0, import_core15.useProps)("MenuItem", defaultProps8, props), {
    classNames,
    className,
    style,
    styles,
  ...
  const handleMouseEnter = (0, import_core15.createEventHandler)(
    _others.onMouseEnter,
    () => ctx.setHovered(ctx.getItemIndex(itemRef.current))
  );
  const handleClick = (0, import_core15.createEventHandler)(_others.onClick, () => {
  ...
  const handleFocus = (0, import_core15.createEventHandler)(
    _others.onFocus,
    () => ctx.setHovered(ctx.getItemIndex(itemRef.current))
  );
  ...
  return /* @__PURE__ */ import_react23.default.createElement(
    ...
    __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, others), {
      ...
      onMouseLeave: handleMouseLeave,
      onClick: handleClick,
      onKeyDown: (0, import_core15.createScopedKeydownHandler)({
...
var MenuTarget = (0, import_react25.forwardRef)(
  (props, ref) => {
    ...
    if (!(0, import_core17.isElement)(children)) {
      throw new Error(
        "Menu.Target component children should be an element or a component that accepts ref. Fragments, strings, numbers and other primitive values are not supported"
      );
    }
    const ctx = useMenuContext();
    const onClick = (0, import_core17.createEventHandler)(
      children.props.onClick,
      () => ctx.trigger === "click" && ctx.toggleDropdown()
    );
    const onMouseEnter = (0, import_core17.createEventHandler)(
      children.props.onMouseEnter,
      () => ctx.trigger === "hover" && ctx.openDropdown()
    );
    const onMouseLeave = (0, import_core17.createEventHandler)(
...
function Menu(_props) {
  ...
  const [_opened, setOpened] = (0, import_hooks10.useUncontrolled)({
    value: opened,
  ...
  const { resolvedClassNames, resolvedStyles } = (0, import_core18.useResolvedStylesApi)({
    classNames,
    styles,
    props
  });
