...
__export(src_exports, {
  HoverCard: () => HoverCard,
  HoverCardDropdown: () => HoverCardDropdown,
  HoverCardTarget: () => HoverCardTarget
});
...
var popIn = {
  ...
  out: { opacity: 0, transform: `scale(.9) translateY(${(0, import_core7.rem)(10)})` },
...
var transitions = {
  ...
  "skew-up": {
    ...
    out: {
      opacity: 0,
      transform: `translateY(-${(0, import_core7.rem)(20)}) skew(-10deg, -5deg)`
    },
    common: { transformOrigin: "top" },
    transitionProperty: "transform, opacity"
  },
  ...
  "rotate-left": {
    ...
    out: { opacity: 0, transform: `translateY(${(0, import_core7.rem)(20)}) rotate(-5deg)` },
    common: { transformOrigin: "bottom" },
    transitionProperty: "transform, opacity"
  },
  "rotate-right": {
...
function HoverCardDropdown(props) {
  const _a = (0, import_core12.useProps)(
    ...
    defaultProps5,
    props
  ), { children, onMouseEnter, onMouseLeave } = _a, others = __objRest(_a, ["children", "onMouseEnter", "onMouseLeave"]);
  const ctx = useHoverCardContext();
  const handleMouseEnter = (0, import_core12.createEventHandler)(
    onMouseEnter,
    ctx.openDropdown
  );
  const handleMouseLeave = (0, import_core12.createEventHandler)(
    onMouseLeave,
    ctx.closeDropdown
  );
...
// src/HoverCardTarget/HoverCardTarget.tsx
var import_react19 = __toESM(require("react"));
var import_core13 = require("@raikou/core");
var defaultProps6 = {
  refProp: "ref"
};
var HoverCardTarget = (0, import_react19.forwardRef)(
  (props, ref) => {
    const _a = (0, import_core13.useProps)(
      "HoverCardTarget",
      defaultProps6,
      props
    ...
    const ctx = useHoverCardContext();
    const onMouseEnter = (0, import_core13.createEventHandler)(
      children.props.onMouseEnter,
      ctx.openDropdown
    );
    const onMouseLeave = (0, import_core13.createEventHandler)(
      children.props.onMouseLeave,
      ctx.closeDropdown
    );
    return /* @__PURE__ */ import_react19.default.createElement(Popover.Target, __spreadValues({ refProp, ref }, others), (0, import_react19.cloneElement)(children, {
      onMouseEnter,
      onMouseLeave
    }));
  }
...
function HoverCard(props) {
  const _a = (0, import_core14.useProps)("HoverCard", defaultProps7, props), {
    children,
    onOpen,
    onClose,
    openDelay,
  ...
  const [opened, { open, close }] = (0, import_hooks9.useDisclosure)(initiallyOpened, {
    onClose,
    onOpen
  });
  ...
  return /* @__PURE__ */ import_react20.default.createElement(HoverCardContextProvider, { value: { openDropdown, closeDropdown } }, /* @__PURE__ */ import_react20.default.createElement(Popover, __spreadProps(__spreadValues({}, others), { opened, __staticSelector: "HoverCard" }), children));
}
