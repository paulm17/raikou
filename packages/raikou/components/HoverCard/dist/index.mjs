...
import { useProps as useProps7 } from "@raikou/core";
...
var Portal = forwardRef3((props, ref) => {
  ...
  return createPortal2(/* @__PURE__ */ React7.createElement(React7.Fragment, null, children), nodeRef.current);
});
...
import { createEventHandler, useProps as useProps5 } from "@raikou/core";
var defaultProps5 = {};
...
import React14, { cloneElement as cloneElement4, forwardRef as forwardRef4 } from "react";
import { isElement as isElement5, createEventHandler as createEventHandler2, useProps as useProps6 } from "@raikou/core";
var defaultProps6 = {
  refProp: "ref"
};
var HoverCardTarget = forwardRef4(
  (props, ref) => {
    const _a = useProps6(
      "HoverCardTarget",
      defaultProps6,
    ...
    const ctx = useHoverCardContext();
    const onMouseEnter = createEventHandler2(
      children.props.onMouseEnter,
      ctx.openDropdown
    );
    const onMouseLeave = createEventHandler2(
...
function HoverCard(props) {
  const _a = useProps7("HoverCard", defaultProps7, props), {
    children,
    onOpen,
    onClose,
    openDelay,
  ...
  return /* @__PURE__ */ React15.createElement(HoverCardContextProvider, { value: { openDropdown, closeDropdown } }, /* @__PURE__ */ React15.createElement(Popover, __spreadProps(__spreadValues({}, others), { opened, __staticSelector: "HoverCard" }), children));
}
