...
var varsResolver6 = (0, import_core9.createVarsResolver)(
  (_, { size: size2 }) => ({
    chevron: {
      "--combobox-chevron-size": (0, import_core9.getSize)(size2, "combobox-chevron-size")
    }
  })
);
var ComboboxChevron = (0, import_core9.factory)(
  (_props, ref) => {
    const props = (0, import_core9.useProps)("ComboboxChevron", defaultProps8, _props);
    const _a = props, {
      size: size2,
      error,
      style,
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react13.useState)(0);
...
function getArrowPositionStyles({
  ...
  const baseStyles = {
    width: (0, import_core12.rem)(arrowSize),
    height: (0, import_core12.rem)(arrowSize),
    transform: "rotate(45deg)",
    position: "absolute",
    [radiusByFloatingSide[side]]: (0, import_core12.rem)(arrowRadius)
  };
  const arrowPlacement = (0, import_core12.rem)(-arrowSize / 2);
  if (side === "left") {
...
// ../Floating/src/FloatingArrow/FloatingArrow.tsx
var FloatingArrow = (0, import_react15.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
      position,
      arrowSize,
...
var PopoverTarget = (0, import_core14.factory)((props, ref) => {
  const _a = (0, import_core14.useProps)(
    "PopoverTarget",
    defaultProps9,
    props
...
var Portal = (0, import_react18.forwardRef)((props, ref) => {
  ...
  return (0, import_react_dom4.createPortal)(
    /* @__PURE__ */ import_react18.default.createElement("div", __spreadValues({ className, ref }, others), children),
    nodeRef.current
  );
});
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react19.default.createElement(Portal, __spreadValues({}, others), children);
  }
...
var popIn = {
  ...
  out: { opacity: 0, transform: `scale(.9) translateY(${(0, import_core16.rem)(10)})` },
...
var transitions = {
  ...
  "skew-up": {
    ...
    out: {
      opacity: 0,
      transform: `translateY(-${(0, import_core16.rem)(20)}) skew(-10deg, -5deg)`
    },
    common: { transformOrigin: "top" },
    transitionProperty: "transform, opacity"
  },
  ...
  "rotate-left": {
    ...
    out: { opacity: 0, transform: `translateY(${(0, import_core16.rem)(20)}) rotate(-5deg)` },
    common: { transformOrigin: "bottom" },
    transitionProperty: "transform, opacity"
  },
  "rotate-right": {
...
function useTransition({
  ...
  const theme = (0, import_core17.useRaikouTheme)();
...
function FocusTrap({
  ...
  if (!(0, import_core18.isElement)(children)) {
    return children;
  }
...
// ../Popover/src/PopoverDropdown/PopoverDropdown.tsx
var defaultProps11 = {};
var PopoverDropdown = (0, import_core19.factory)(
  (_props, ref) => {
    var _b, _c, _d, _e, _f;
    const props = (0, import_core19.useProps)("PopoverDropdown", defaultProps11, _props);
    const _a = props, {
      className,
      style,
      unstyled,
    ...
    return /* @__PURE__ */ import_react23.default.createElement(OptionalPortal, __spreadProps(__spreadValues({}, ctx.portalProps), { withinPortal: ctx.withinPortal }), /* @__PURE__ */ import_react23.default.createElement(
      Transition,
      ...
      (transitionStyles) => {
        var _a2, _b2;
        return /* @__PURE__ */ import_react23.default.createElement(FocusTrap, { active: ctx.trapFocus }, /* @__PURE__ */ import_react23.default.createElement(
          import_core19.Box,
          __spreadValues(__spreadProps(__spreadValues(__spreadValues({}, accessibleProps), others), {
            variant,
            ref: mergedRef,
            onKeyDownCapture: (0, import_core19.closeOnEscape)(ctx.onClose, {
            ...
            style: [
              __spreadProps(__spreadValues({}, transitionStyles), {
                ...
                width: ctx.width === "target" ? void 0 : (0, import_core19.rem)(ctx.width)
              }),
              style
            ]
          })),
...
var defaultProps12 = {
  ...
  zIndex: (0, import_core20.getDefaultZIndex)("popover"),
  __staticSelector: "Popover",
  width: "max-content"
};
var varsResolver7 = (0, import_core20.createVarsResolver)(
  (_, { radius, shadow }) => ({
    dropdown: {
      "--popover-radius": (0, import_core20.getRadius)(radius),
      "--popover-shadow": (0, import_core20.getShadow)(shadow)
    }
  })
);
function Popover(_props) {
  var _b, _c, _d, _e, _f, _g;
  const props = (0, import_core20.useProps)("Popover", defaultProps12, _props);
  const _a = props, {
    children,
    position,
    offset: offset2,
  ...
  const arrowRef = (0, import_react24.useRef)(null);
  const [targetNode, setTargetNode] = (0, import_react24.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react24.useState)(null);
  ...
  const reference = (0, import_react24.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react24.useCallback)(
    (node) => {
...
function useCombobox({
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_hooks10.useUncontrolled)({
    value: opened,
    defaultValue: defaultOpened,
    finalValue: false,
    onChange: onOpenedChange
  });
  const listId = (0, import_react25.useRef)(null);
  const selectedOptionIndex = (0, import_react25.useRef)(-1);
  const searchRef = (0, import_react25.useRef)(null);
  const targetRef = (0, import_react25.useRef)(null);
  const focusSearchTimeout = (0, import_react25.useRef)(-1);
  const focusTargetTimeout = (0, import_react25.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react25.useRef)(-1);
  const openDropdown = (0, import_react25.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react25.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react25.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react25.useCallback)(() => {
  ...
  const selectOption = (0, import_react25.useCallback)(
    (index3) => {
  ...
  const selectActiveOption = (0, import_react25.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react25.useCallback)(
    () => selectOption(
      getNextIndex(
  ...
  const selectPreviousOption = (0, import_react25.useCallback)(
    () => selectOption(
      getPreviousIndex(
        selectedOptionIndex.current,
        document.querySelectorAll(
  ...
  const selectFirstOption = (0, import_react25.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(
          `#${listId.current} [data-combobox-option]`
  ...
  const updateSelectedOptionIndex = (0, import_react25.useCallback)(
    (target = "selected") => {
  ...
  const resetSelectedOption = (0, import_react25.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react25.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react25.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react25.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(
      () => searchRef.current.focus(),
      0
    );
  }, []);
  const focusTarget = (0, import_react25.useCallback)(() => {
...
function useComboboxTargetProps({
  ...
  const [selectedOptionId, setSelectedOptionId] = (0, import_react26.useState)(null);
...
var ComboboxTarget = (0, import_core21.factory)((props, ref) => {
  const _a = (0, import_core21.useProps)("ComboboxTarget", defaultProps13, props), {
    children,
    refProp,
    withKeyboardNavigation,
    withAriaAttributes,
  ...
  const clonedElement = (0, import_react27.cloneElement)(children, __spreadValues(__spreadValues({}, targetProps), others));
  return /* @__PURE__ */ import_react27.default.createElement(Popover.Target, { ref: (0, import_hooks11.useMergedRef)(ref, ctx.store.targetRef) }, clonedElement);
});
...
var defaultProps14 = {};
var ComboboxDropdown = (0, import_core22.factory)(
  (props, ref) => {
    const _a = (0, import_core22.useProps)("ComboboxDropdown", defaultProps14, props), { classNames, styles, className, style, hidden } = _a, others = __objRest(_a, ["classNames", "styles", "className", "style", "hidden"]);
    const ctx = useComboboxContext();
...
var defaultProps16 = {};
var ComboboxOption = (0, import_core24.factory)((_props, ref) => {
  const props = (0, import_core24.useProps)("ComboboxOption", defaultProps16, _props);
  const _a = props, {
    classNames,
    className,
    style,
...
var ComboboxSearch = (0, import_core25.factory)((_props, ref) => {
  const props = (0, import_core25.useProps)("ComboboxSearch", defaultProps17, _props);
  const _a = props, {
    classNames,
    styles,
    unstyled,
...
var ComboboxEventsTarget = (0, import_core29.factory)(
  (props, ref) => {
    const _a = (0, import_core29.useProps)("ComboboxEventsTarget", defaultProps21, props), {
      children,
      refProp,
      withKeyboardNavigation,
      withAriaAttributes,
...
var ComboboxDropdownTarget = (0, import_core30.factory)(
  (props, ref) => {
    const { children, refProp } = (0, import_core30.useProps)(
...
var defaultProps23 = {};
var ComboboxGroup = (0, import_core31.factory)((props, ref) => {
  const _a = (0, import_core31.useProps)("ComboboxGroup", defaultProps23, props), {
    classNames,
    className,
    style,
    styles,
...
var varsResolver8 = (0, import_core32.createVarsResolver)(
  (_, { size: size2, dropdownPadding }) => ({
    ...
    dropdown: {
      "--combobox-padding": (0, import_core32.rem)(dropdownPadding),
      "--combobox-option-fz": (0, import_core32.getFontSize)(size2),
      "--combobox-option-padding": (0, import_core32.getSize)(size2, "combobox-option-padding")
    }
  })
...
var ScrollAreaAutosize = (0, import_core36.factory)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react51.default.createElement(import_core36.Box, __spreadProps(__spreadValues({}, others), { ref, style: [{ display: "flex" }, style] }), /* @__PURE__ */ import_react51.default.createElement(import_core36.Box, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ import_react51.default.createElement(
    ScrollArea,
    {
      classNames,
      styles,
...
var Select = (0, import_core38.factory)((_props, ref) => {
  const props = (0, import_core38.useProps)("Select", defaultProps27, _props);
  const _a = props, {
    classNames,
    styles,
    unstyled,
  ...
  const [_value, setValue] = (0, import_hooks24.useUncontrolled)({
    value,
    defaultValue,
    finalValue: null,
    onChange
  ...
  return /* @__PURE__ */ import_react54.default.createElement(
    ...
    /* @__PURE__ */ import_react54.default.createElement(Combobox.Target, { targetType: searchable ? "input" : "button" }, /* @__PURE__ */ import_react54.default.createElement(
      InputBase,
      __spreadProps(__spreadValues({
        ref,
        rightSection: rightSection || /* @__PURE__ */ import_react54.default.createElement(Combobox.Chevron, { size: size2 })
      }, others), {
        size: size2,
        __staticSelector: "Select",
        disabled,
