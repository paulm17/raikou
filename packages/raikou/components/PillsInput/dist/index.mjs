...
// src/PillsInput.tsx
import React11, { useRef } from "react";
...
var PillsInputField = factory6(
  (_props, ref) => {
    const props = useProps8("PillsInputField", defaultProps8, _props);
    const _a = props, {
      classNames,
      className,
      style,
...
// src/PillsInput.tsx
var defaultProps9 = {};
var PillsInput = factory7((_props, ref) => {
  const props = useProps9("PillsInput", defaultProps9, _props);
  const _a = props, {
    children,
    onMouseDown,
    onClick,
