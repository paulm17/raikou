...
type PasswordInputStylesNames = "root" | "visibilityToggle" | "innerInput" | __InputStylesNames;
type PasswordInputCssVariables = {
    root: "--psi-icon-size" | "--psi-button-size";
};
interface PasswordInputProps extends Omit<InputBaseProps, "classNames" | "styles" | "vars">, StylesApiProps<PasswordInputFactory>, ElementProps<"input", "size"> {
    /** Custom visibility toggle icon */
    visibilityToggleIcon?: React$1.FC<{
        reveal: boolean;
    }>;
...
declare const PasswordInput: _raikou_core.RaikouComponent<{
    props: PasswordInputProps;
    ref: HTMLInputElement;
    stylesNames: PasswordInputStylesNames;
    vars: PasswordInputCssVariables;
