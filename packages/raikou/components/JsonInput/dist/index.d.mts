...
interface JsonInputProps extends Omit<TextareaProps, "onChange"> {
    ...
    validationError?: React$1.ReactNode;
...
type JsonInputFactory = Factory<{
    props: JsonInputProps;
    ref: HTMLTextAreaElement;
    stylesNames: __InputStylesNames;
}>;
declare const JsonInput: _raikou_core.RaikouComponent<{
    props: JsonInputProps;
    ref: HTMLTextAreaElement;
    stylesNames: __InputStylesNames;
}>;
