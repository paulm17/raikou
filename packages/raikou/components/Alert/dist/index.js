...
var varsResolver4 = (0, import_core9.createVarsResolver)(
  (theme, { radius, color, variant }) => {
    ...
    return {
      root: {
        "--alert-radius": (0, import_core9.getRadius)(radius),
...
var Alert = (0, import_core9.factory)((_props, ref) => {
  const props = (0, import_core9.useProps)("Alert", defaultProps6, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  const rootId = `${(0, import_core9.useId)()}-${id}`;
  ...
  return /* @__PURE__ */ import_react10.default.createElement(
    ...
    /* @__PURE__ */ import_react10.default.createElement("div", __spreadValues({}, getStyles("wrapper")), icon && /* @__PURE__ */ import_react10.default.createElement("div", __spreadValues({}, getStyles("icon")), icon), /* @__PURE__ */ import_react10.default.createElement("div", __spreadValues({}, getStyles("body")), title && /* @__PURE__ */ import_react10.default.createElement(
      "div",
      __spreadProps(__spreadValues({}, getStyles("title")), {
        "data-with-close-button": withCloseButton || void 0
      }),
      /* @__PURE__ */ import_react10.default.createElement("span", __spreadValues({ id: titleId }, getStyles("label")), title)
    ), /* @__PURE__ */ import_react10.default.createElement("div", __spreadValues({ id: bodyId }, getStyles("message")), children)), withCloseButton && /* @__PURE__ */ import_react10.default.createElement(
      CloseButton,
