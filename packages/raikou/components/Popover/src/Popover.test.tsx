...
describe("@raikou/core/Popover", () => {
  ...
  it("correctly handles trapFocus={false}", async () => {
    const { container } = render(
      <TestContainer defaultOpened trapFocus={false} />
    );
    await wait(10);
  ...
  it("correctly handles withArrow={true}", () => {
    ...
    expect(container.querySelectorAll(".raikou-Popover-arrow")).toHaveLength(1);
  });
  ...
  it("correctly handles withArrow={false}", () => {
    ...
    expect(container.querySelectorAll(".raikou-Popover-arrow")).toHaveLength(0);
  });
