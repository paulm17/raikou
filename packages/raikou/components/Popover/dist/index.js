...
function getPopoverMiddlewares(options) {
  var _a, _b, _c;
  const middlewares = [(0, import_react4.offset)(options.offset)];
  if ((_a = options.middlewares) == null ? void 0 : _a.shift) {
    middlewares.push((0, import_react4.shift)({ limiter: (0, import_react4.limitShift)() }));
  }
  if ((_b = options.middlewares) == null ? void 0 : _b.flip) {
    middlewares.push((0, import_react4.flip)());
  }
  if ((_c = options.middlewares) == null ? void 0 : _c.inline) {
    middlewares.push((0, import_react4.inline)());
  }
  middlewares.push(
    (0, import_react4.arrow)({ element: options.arrowRef, padding: options.arrowOffset })
  );
  return middlewares;
}
...
var PopoverTarget = (0, import_core3.factory)((props, ref) => {
  ...
  return (0, import_react7.cloneElement)(children, __spreadValues(__spreadProps(__spreadValues(__spreadValues(__spreadValues({}, forwardedProps), accessibleProps), ctx.targetProps), {
...
function FocusTrap({
  ...
  return (0, import_react12.cloneElement)(children, { [refProp]: ref });
}
FocusTrap.displayName = "@raikou/core/FocusTrap";

// src/PopoverDropdown/PopoverDropdown.tsx
var defaultProps3 = {};
var PopoverDropdown = (0, import_core8.factory)(
  (_props, ref) => {
    var _b, _c, _d, _e, _f;
    const props = (0, import_core8.useProps)("PopoverDropdown", defaultProps3, _props);
    const _a = props, {
      className,
      style,
      unstyled,
    ...
    return /* @__PURE__ */ import_react13.default.createElement(OptionalPortal, __spreadProps(__spreadValues({}, ctx.portalProps), { withinPortal: ctx.withinPortal }), /* @__PURE__ */ import_react13.default.createElement(
      Transition,
      ...
      (transitionStyles) => {
        var _a2, _b2;
        return /* @__PURE__ */ import_react13.default.createElement(FocusTrap, { active: ctx.trapFocus }, /* @__PURE__ */ import_react13.default.createElement(
          import_core8.Box,
          __spreadValues(__spreadProps(__spreadValues(__spreadValues({}, accessibleProps), others), {
            variant,
            ref: mergedRef,
            onKeyDownCapture: (0, import_core8.closeOnEscape)(ctx.onClose, {
            ...
            style: [
              __spreadProps(__spreadValues({}, transitionStyles), {
                ...
                width: ctx.width === "target" ? void 0 : (0, import_core8.rem)(ctx.width)
              }),
              style
            ]
          })),
...
var defaultProps4 = {
  ...
  zIndex: (0, import_core9.getDefaultZIndex)("popover"),
...
var varsResolver = (0, import_core9.createVarsResolver)(
  (_, { radius, shadow }) => ({
    dropdown: {
      "--popover-radius": (0, import_core9.getRadius)(radius),
      "--popover-shadow": (0, import_core9.getShadow)(shadow)
    }
  })
);
function Popover(_props) {
  var _b, _c, _d, _e, _f, _g;
  const props = (0, import_core9.useProps)("Popover", defaultProps4, _props);
  const _a = props, {
    children,
    position,
    offset: offset2,
  ...
  const arrowRef = (0, import_react14.useRef)(null);
  const [targetNode, setTargetNode] = (0, import_react14.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react14.useState)(null);
  ...
  const reference = (0, import_react14.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react14.useCallback)(
    (node) => {
