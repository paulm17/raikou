...
// src/use-popover.ts
var import_react63 = require("@floating-ui/react");
function getPopoverMiddlewares(options) {
  var _a, _b, _c;
  const middlewares = [(0, import_react63.offset)(options.offset)];
  if ((_a = options.middlewares) == null ? void 0 : _a.shift) {
    middlewares.push((0, import_react63.shift)({ limiter: (0, import_react63.limitShift)() }));
  }
  if ((_b = options.middlewares) == null ? void 0 : _b.flip) {
    middlewares.push((0, import_react63.flip)());
  }
  if ((_c = options.middlewares) == null ? void 0 : _c.inline) {
    middlewares.push((0, import_react63.inline)());
  }
  middlewares.push(
    (0, import_react63.arrow)({ element: options.arrowRef, padding: options.arrowOffset })
  );
  return middlewares;
}
function usePopover(options) {
  ...
  const floating = (0, import_react63.useFloating)({
    placement: options.position,
    middleware: [
      ...getPopoverMiddlewares(options),
      ...options.width === "target" ? [
        (0, import_react63.size)({
          apply({ rects }) {
            var _a, _b;
...
function createSafeContext(errorMessage) {
  const Context = (0, import_react64.createContext)(null);
  const useSafeContext = () => {
    const ctx = (0, import_react64.useContext)(Context);
    if (ctx === null) {
      throw new Error(errorMessage);
    }
    return ctx;
  };
  const Provider = ({ children, value }) => /* @__PURE__ */ import_react64.default.createElement(Context.Provider, { value }, children);
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react66.cloneElement)(children, __spreadValues(__spreadProps(__spreadValues(__spreadValues(__spreadValues({}, forwardedProps), accessibleProps), ctx.targetProps), {
...
var Portal = (0, import_react67.forwardRef)((props, ref) => {
  ...
  return (0, import_react_dom.createPortal)(
    /* @__PURE__ */ import_react67.default.createElement("div", __spreadValues({ className, ref }, others), children),
    nodeRef.current
  );
});
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react68.default.createElement(Portal, __spreadValues({}, others), children);
  }
...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react69.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react69.useState)(
  ...
  (0, import_react69.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react70.default.createElement(import_react70.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react70.default.createElement(import_react70.default.Fragment, null, children(
    getTransitionStyles({
      transition,
...
var PopoverDropdown = factory(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ import_react72.default.createElement(OptionalPortal, __spreadProps(__spreadValues({}, ctx.portalProps), { withinPortal: ctx.withinPortal }), /* @__PURE__ */ import_react72.default.createElement(
      Transition,
      ...
      (transitionStyles) => {
        var _a2, _b2;
        return /* @__PURE__ */ import_react72.default.createElement(FocusTrap, { active: ctx.trapFocus }, /* @__PURE__ */ import_react72.default.createElement(
          Box,
...
function Popover(_props) {
  ...
  const [targetNode, setTargetNode] = (0, import_react73.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react73.useState)(null);
  const { dir } = useDirection();
  const uid = useId(id);
  ...
  const reference = (0, import_react73.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react73.useCallback)(
    (node) => {
