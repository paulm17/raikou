...
// src/Popover.tsx
import React10, { useRef as useRef3, useState as useState5, useCallback } from "react";
...
function Popover(_props) {
  ...
  const [targetNode, setTargetNode] = useState5(null);
  const [dropdownNode, setDropdownNode] = useState5(null);
