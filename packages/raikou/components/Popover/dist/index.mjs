...
// src/Popover.tsx
import React10, { useRef as useRef3, useState as useState4, useCallback } from "react";
...
import { isElement, useProps, factory } from "@raikou/core";
var defaultProps = {
  refProp: "ref",
  popupType: "dialog"
};
...
import React5, { useRef, useState as useState2, forwardRef as forwardRef2 } from "react";
...
function useTransition({
  ...
  const [transitionStatus, setStatus] = useState3(
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ React7.createElement(React7.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ React7.createElement(React7.Fragment, null, children(
    getTransitionStyles({
      transition,
...
import { isElement as isElement2 } from "@raikou/core";
function FocusTrap({
  children,
  active = true,
  refProp = "ref"
...
var PopoverDropdown = factory2(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ React9.createElement(OptionalPortal, __spreadProps(__spreadValues({}, ctx.portalProps), { withinPortal: ctx.withinPortal }), /* @__PURE__ */ React9.createElement(
      Transition,
      ...
      (transitionStyles) => {
        var _a2, _b2;
        return /* @__PURE__ */ React9.createElement(FocusTrap, { active: ctx.trapFocus }, /* @__PURE__ */ React9.createElement(
          Box,
...
function Popover(_props) {
  ...
  const [targetNode, setTargetNode] = useState4(null);
  const [dropdownNode, setDropdownNode] = useState4(null);
