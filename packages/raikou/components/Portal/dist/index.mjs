...
// src/Portal.tsx
import React4, { useRef as useRef26, useState as useState32, forwardRef as forwardRef4 } from "react";
...
var Portal = forwardRef4((props, ref) => {
  ...
  return createPortal(
    /* @__PURE__ */ React4.createElement("div", __spreadValues({ className, ref }, others), children),
    nodeRef.current
  );
});
Portal.displayName = "@raikou/core/Portal";

// src/OptionalPortal.tsx
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ React5.createElement(Portal, __spreadValues({}, others), children);
  }
