...
var CloseButton = (0, import_core7.polymorphicFactory)(
  (_props, ref) => {
    const props = (0, import_core7.useProps)("CloseButton", defaultProps5, _props);
    const _a = props, {
      iconSize,
      children,
      vars,
...
var varsResolver4 = (0, import_core8.createVarsResolver)((_, { size }) => ({
  root: {
    "--dialog-size": (0, import_core8.getSize)(size, "dialog-size")
  }
}));
var Dialog = (0, import_core8.factory)((_props, ref) => {
  const props = (0, import_core8.useProps)("Dialog", defaultProps6, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react10.default.createElement(
    ...
    /* @__PURE__ */ import_react10.default.createElement(
      ...
      (transitionStyles) => /* @__PURE__ */ import_react10.default.createElement(
        Paper,
        __spreadValues(__spreadValues({
          unstyled
        }, getStyles("root", { style: transitionStyles })), others),
        withCloseButton && /* @__PURE__ */ import_react10.default.createElement(CloseButton, __spreadValues({ onClick: onClose }, getStyles("closeButton"))),
        children
      )
    )
  );
