...
var ModalBaseHeader = forwardRef9(
  (_a, ref) => {
    var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
    return /* @__PURE__ */ React21.createElement(Box5, __spreadValues({ ref, className: clsx_default(ModalBase_module_default.header, className) }, others));
  }
);
...
var DrawerRoot = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React26.createElement(DrawerProvider, { value: { scrollAreaComponent, getStyles: getStyles2, radius } }, /* @__PURE__ */ React26.createElement(
    ModalBase,
    __spreadValues(__spreadProps(__spreadValues({
      ref
    }, getStyles2("root")), {
