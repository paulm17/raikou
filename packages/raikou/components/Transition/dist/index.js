...
__export(src_exports, {
  MANTINE_TRANSITIONS: () => transitions,
...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react60.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react60.useState)(
    mounted ? "entered" : "exited"
  );
  const timeoutRef = (0, import_react60.useRef)(-1);
  ...
  (0, import_react60.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react61.default.createElement(import_react61.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react61.default.createElement(import_react61.default.Fragment, null, children(
    getTransitionStyles({
      transition,
