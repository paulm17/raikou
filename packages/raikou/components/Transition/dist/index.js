...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react.useState)(
  ...
  (0, import_react.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react2.default.createElement(import_react2.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react2.default.createElement(import_react2.default.Fragment, null, children(
    getTransitionStyles({
      transition,
