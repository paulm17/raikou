...
declare const SwitchGroup: _raikou_core.RaikouComponent<{
    props: SwitchGroupProps;
    ref: HTMLDivElement;
    stylesNames: SwitchGroupStylesNames;
}>;
...
interface SwitchProps extends BoxProps, StylesApiProps<SwitchFactory>, ElementProps<"input", "size"> {
...
declare const Switch: _raikou_core.RaikouComponent<{
    props: SwitchProps;
    ref: HTMLInputElement;
    stylesNames: SwitchStylesNames;
    vars: SwitchCssVariables;
