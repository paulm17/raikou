...
var SwitchGroupContext = (0, import_react69.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react69.useContext)(SwitchGroupContext);

// src/SwitchGroup/SwitchGroup.tsx
var import_react70 = __toESM(require("react"));
var defaultProps7 = {};
var SwitchGroup = factory((props, ref) => {
  const _a = useProps("SwitchGroup", defaultProps7, props), {
    value,
    defaultValue,
    onChange,
    size,
...
var Switch = factory((_props, ref) => {
  var _b;
  const props = useProps("Switch", defaultProps8, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react71.default.createElement(
    ...
    /* @__PURE__ */ import_react71.default.createElement(
      ...
      /* @__PURE__ */ import_react71.default.createElement(Box, __spreadValues({ component: "span", mod: "reduce-motion" }, getStyles("thumb")), thumbIcon),
      /* @__PURE__ */ import_react71.default.createElement("span", __spreadValues({}, getStyles("trackLabel")), _checked ? onLabel : offLabel)
    )
  );
});
