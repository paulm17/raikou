...
var Bars = (0, import_react4.forwardRef)(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ import_react4.default.createElement(
      ...
      /* @__PURE__ */ import_react4.default.createElement("span", { className: Loader_module_default.bar }),
      /* @__PURE__ */ import_react4.default.createElement("span", { className: Loader_module_default.bar }),
      /* @__PURE__ */ import_react4.default.createElement("span", { className: Loader_module_default.bar })
    );
  }
...
var Dots = (0, import_react7.forwardRef)(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ import_react7.default.createElement(
      ...
      /* @__PURE__ */ import_react7.default.createElement("span", { className: Loader_module_default.dot }),
      /* @__PURE__ */ import_react7.default.createElement("span", { className: Loader_module_default.dot }),
      /* @__PURE__ */ import_react7.default.createElement("span", { className: Loader_module_default.dot })
    );
  }
...
var varsResolver2 = (0, import_core11.createVarsResolver)(
  (theme, { color, iconSize, size, contentPadding, radius }) => ({
    root: {
      "--stepper-color": color ? (0, import_core11.getThemeColor)(color, theme) : void 0,
      ...
      "--stepper-radius": radius === void 0 ? void 0 : (0, import_core11.getRadius)(radius),
