...
const regHsla =
  /^hsla\((0|360|35\d|3[0-4]\d|[12]\d\d|0?\d?\d),(0|100|\d{1,2})%,(0|100|\d{1,2})%,0|(0?\.\d|1(\.0)?)\)$/
const regRgb =
...
const regGradientNoConic =
  /^(linear\-gradient\(|radial\-gradient\(|repeating\-linear\-gradient\(|repeating\-radial\-gradient\().*\)$/

export { regHex, regHsl, regHsla, regRgb, regRgba, regGradient, regGradientNoConic }
