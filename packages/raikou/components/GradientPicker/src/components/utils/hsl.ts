import { getRgbHslValues } from "./colors";
 ...
 * @since 1.0.0
 */
const toHsb = (rr: number, gg: number, bb: number) => {
 ...
 * @since 1.0.0
 */
const getValuesFromHsl = (clr: string) => {
...
export { toHsl, hsbaData, hslToRgb, getValuesFromHsl };
