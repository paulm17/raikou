...
var [PaginationProvider, usePaginationContext] = (0, import_core2.createSafeContext)(
...
var varsResolver2 = (0, import_core3.createVarsResolver)(
  (theme, { size, radius, color }) => ({
    root: {
      "--pagination-control-radius": (0, import_core3.getRadius)(radius),
      "--pagination-control-size": (0, import_core3.getSize)(size, "pagination-control-size"),
      "--pagination-control-fz": (0, import_core3.getFontSize)(size),
      "--pagination-active-bg": (0, import_core3.getThemeColor)(color, theme)
    }
  })
);
var PaginationRoot = (0, import_core3.factory)((_props, ref) => {
  const props = (0, import_core3.useProps)("PaginationRoot", defaultProps2, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  const handleNextPage = (0, import_core3.createEventHandler)(onNextPage, next);
  const handlePreviousPage = (0, import_core3.createEventHandler)(onPreviousPage, previous);
  const handleFirstPage = (0, import_core3.createEventHandler)(onFirstPage, first);
  const handleLastPage = (0, import_core3.createEventHandler)(onLastPage, last);
  return /* @__PURE__ */ import_react3.default.createElement(
    ...
    /* @__PURE__ */ import_react3.default.createElement(import_core3.Box, __spreadValues(__spreadValues({ ref }, getStyles("root")), others))
  );
});
...
var UnstyledButton = (0, import_core4.polymorphicFactory)(
  (_props, ref) => {
    const props = (0, import_core4.useProps)("UnstyledButton", defaultProps3, _props);
    const _a = props, {
      className,
      component = "button",
      __staticSelector,
...
var PaginationControl = (0, import_core5.factory)(
  (_props, ref) => {
    const props = (0, import_core5.useProps)("PaginationControl", defaultProps4, _props);
    const _a = props, {
      classNames,
      className,
      style,
...
function PaginationIcon(_a) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(
    ...
    /* @__PURE__ */ import_react6.default.createElement("path", { d: path, fill: "currentColor" })
  );
}
var PaginationNextIcon = (props) => /* @__PURE__ */ import_react6.default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
    path: "M8.781 8l-3.3-3.3.943-.943L10.667 8l-4.243 4.243-.943-.943 3.3-3.3z"
  })
);
var PaginationPreviousIcon = (props) => /* @__PURE__ */ import_react6.default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
    path: "M7.219 8l3.3 3.3-.943.943L5.333 8l4.243-4.243.943.943-3.3 3.3z"
  })
);
var PaginationFirstIcon = (props) => /* @__PURE__ */ import_react6.default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
...
var PaginationLastIcon = (props) => /* @__PURE__ */ import_react6.default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
...
var PaginationDotsIcon = (props) => /* @__PURE__ */ import_react6.default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
...
var PaginationDots = (0, import_core6.factory)((_props, ref) => {
  const props = (0, import_core6.useProps)("PaginationDots", defaultProps5, _props);
  const _a = props, {
    classNames,
    className,
    style,
...
function createEdgeComponent({
  ...
  const Component = (0, import_react8.forwardRef)(
    (props, ref) => {
      const _a = (0, import_core7.useProps)(name, defaultProps7, props), { icon: _icon } = _a, others = __objRest(_a, ["icon"]);
      const Icon = _icon;
      const ctx = usePaginationContext();
  ...
  return (0, import_core7.createPolymorphicComponent)(Component);
}
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index) => {
    var _a;
    if (page === "dots") {
      return /* @__PURE__ */ import_react9.default.createElement(PaginationDots, { icon: dotsIcon, key: index });
    }
  ...
  return /* @__PURE__ */ import_react9.default.createElement(import_react9.default.Fragment, null, items);
}
...
var Pagination = (0, import_core8.factory)((_props, ref) => {
  const props = (0, import_core8.useProps)("Pagination", defaultProps6, _props);
  const _a = props, {
    withEdges,
    withControls,
    getControlProps,
  ...
  return /* @__PURE__ */ import_react10.default.createElement(PaginationRoot, __spreadValues({ ref, total }, others), /* @__PURE__ */ import_react10.default.createElement(Group, { gap }, withEdges && /* @__PURE__ */ import_react10.default.createElement(PaginationFirst, __spreadValues({ icon: firstIcon }, getControlProps == null ? void 0 : getControlProps("first"))), withControls && /* @__PURE__ */ import_react10.default.createElement(
    PaginationPrevious,
    __spreadValues({
      icon: previousIcon
    }, getControlProps == null ? void 0 : getControlProps("previous"))
  ), /* @__PURE__ */ import_react10.default.createElement(PaginationItems, { dotsIcon }), withControls && /* @__PURE__ */ import_react10.default.createElement(PaginationNext, __spreadValues({ icon: nextIcon }, getControlProps == null ? void 0 : getControlProps("next"))), withEdges && /* @__PURE__ */ import_react10.default.createElement(PaginationLast, __spreadValues({ icon: lastIcon }, getControlProps == null ? void 0 : getControlProps("last")))));
});
