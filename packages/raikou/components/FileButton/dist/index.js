...
var FileButton = (0, import_react60.forwardRef)((props, ref) => {
  const {
    onChange,
    children,
    multiple,
  ...
  return /* @__PURE__ */ import_react60.default.createElement(import_react60.default.Fragment, null, children({ onClick, ...others }), /* @__PURE__ */ import_react60.default.createElement(
    "input",
    {
      style: { display: "none" },
      type: "file",
