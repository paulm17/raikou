...
var FileButton = forwardRef((props, ref) => {
  const _a = useProps("FileButton", defaultProps, props), {
    onChange,
    children,
    multiple,
    accept,
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, children(__spreadValues({ onClick }, others)), /* @__PURE__ */ React.createElement(
    "input",
    __spreadValues({
      style: { display: "none" },
      type: "file",
