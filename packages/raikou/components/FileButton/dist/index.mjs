...
// src/FileButton.tsx
import React4, { useRef as useRef26, forwardRef as forwardRef4 } from "react";
...
var FileButton = forwardRef4((props, ref) => {
  const {
    onChange,
    children,
    multiple,
  ...
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, children({ onClick, ...others }), /* @__PURE__ */ React4.createElement(
    "input",
    {
      style: { display: "none" },
      type: "file",
