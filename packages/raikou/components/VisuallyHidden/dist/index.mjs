...
return target;};import React from"react";import cx from"clsx";var VisuallyHidden_module_default={"root":"m-515a97f8"};function VisuallyHidden(_a){var _b=_a,{className}=_b,others=__objRest(_b,["className"]);return React.createElement("span",__spreadValues({className:cx(VisuallyHidden_module_default.root,className)},others));}
VisuallyHidden.displayName="@raikou/core/VisuallyHidden";export{VisuallyHidden};