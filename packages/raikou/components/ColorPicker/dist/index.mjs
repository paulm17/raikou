...
// src/ColorPicker.tsx
import React13, { useRef as useRef28, useState as useState34 } from "react";
...
import React7, { useRef as useRef26, useState as useState32, forwardRef as forwardRef5 } from "react";
...
var ColorSlider = forwardRef5(
  (props, ref) => {
    ...
    const { getStyles } = useColorPickerContext();
    const theme = DEFAULT_THEME;
    const [position, setPosition] = useState32({ y: 0, x: value / maxValue });
    const positionRef = useRef26(position);
    ...
    const layers = overlays.map((overlay, index) => /* @__PURE__ */ React7.createElement("div", __spreadProps(__spreadValues({}, getStyles("sliderOverlay")), { style: overlay, key: index })));
...
import React10, { useEffect as useEffect34, useRef as useRef27, useState as useState33 } from "react";
...
function Saturation(_a) {
  ...
  const { getStyles } = useColorPickerContext();
  const [position, setPosition] = useState33({
    x: value.s / 100,
    y: 1 - value.v / 100
  });
  const positionRef = useRef27(position);
  const { ref } = useMove(
    ({ x, y }) => {
      positionRef.current = { x, y };
...
import React12, { forwardRef as forwardRef8 } from "react";
...
var ColorSwatch = polymorphicFactory(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ React11.createElement(
      ...
      /* @__PURE__ */ React11.createElement("span", __spreadValues({}, getStyles("alphaOverlay"))),
      withShadow && /* @__PURE__ */ React11.createElement("span", __spreadValues({}, getStyles("shadowOverlay"))),
      /* @__PURE__ */ React11.createElement(
        "span",
        __spreadValues({}, getStyles("colorOverlay", { style: { backgroundColor: color } }))
      ),
      /* @__PURE__ */ React11.createElement("span", __spreadValues({}, getStyles("childrenOverlay")), children)
    );
  }
);
...
var Swatches = forwardRef8(
  (_a, ref) => {
    ...
    const { getStyles } = useColorPickerContext();
    const colors = data.map((color, index) => /* @__PURE__ */ React12.createElement(
      ColorSwatch,
    ...
    return /* @__PURE__ */ React12.createElement(Box, __spreadValues(__spreadProps(__spreadValues({}, getStyles("swatches")), { ref }), others), colors);
  }
);
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = useRef28(format);
  const valueRef = useRef28();
  const scrubTimeoutRef = useRef28(-1);
  const isScrubbingRef = useRef28(false);
  ...
  const [parsed, setParsed] = useState34(parseColor(_value));
  const startScrubbing = () => {
  ...
  return /* @__PURE__ */ React13.createElement(ColorPickerProvider, { value: { getStyles } }, /* @__PURE__ */ React13.createElement(Box, __spreadValues(__spreadProps(__spreadValues({ ref }, getStyles("wrapper")), { size }), others), withPicker && /* @__PURE__ */ React13.createElement(React13.Fragment, null, /* @__PURE__ */ React13.createElement(
    Saturation,
    {
      value: parsed,
  ...
  ), /* @__PURE__ */ React13.createElement("div", __spreadValues({}, getStyles("body")), /* @__PURE__ */ React13.createElement("div", __spreadValues({}, getStyles("sliders")), /* @__PURE__ */ React13.createElement(
    HueSlider,
    {
      value: parsed.h,
  ...
  ), withAlpha && /* @__PURE__ */ React13.createElement(
    AlphaSlider,
    {
      value: parsed.a,
  ...
  ))), Array.isArray(swatches) && /* @__PURE__ */ React13.createElement(
    Swatches,
    {
      data: swatches,
      swatchesPerRow,
