...
return to;};var __toESM=(mod,isNodeMode,target)=>(target=mod!=null?__create(__getProtoOf(mod)):{},__copyProps(isNodeMode||!mod||!mod.__esModule?__defProp(target,"default",{value:mod,enumerable:true}):target,mod));var __toCommonJS=(mod)=>__copyProps(__defProp({},"__esModule",{value:true}),mod);var src_exports={};__export(src_exports,{NumberFormatter:()=>NumberFormatter});module.exports=__toCommonJS(src_exports);var import_react=__toESM(require("react"));var import_react_number_format=require("react-number-format");var import_core=require("@raikou/core");var defaultProps={};function NumberFormatter(_props){const props=(0,import_core.useProps)("NumberFormatter",defaultProps,_props);const _a=props,{value,defaultValue}=_a,others=__objRest(_a,["value","defaultValue"]);if(value===void 0){return null;}
return import_react.default.createElement(import_react_number_format.NumericFormat,__spreadValues({displayType:"text",value},others));}
var extendNumberFormatter=(c)=>c;NumberFormatter.extend=extendNumberFormatter;NumberFormatter.displayName="@raikou/core/NumberFormatter";0&&(module.exports={NumberFormatter});