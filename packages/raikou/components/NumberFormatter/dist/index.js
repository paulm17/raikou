...
// src/NumberFormatter.tsx
var import_react = __toESM(require("react"));
var import_react_number_format = require("react-number-format");
var import_core = require("@raikou/core");
var defaultProps = {};
function NumberFormatter(_props) {
  const props = (0, import_core.useProps)("NumberFormatter", defaultProps, _props);
  const _a = props, { value, defaultValue } = _a, others = __objRest(_a, ["value", "defaultValue"]);
  if (value === void 0) {
    return null;
  }
  return /* @__PURE__ */ import_react.default.createElement(import_react_number_format.NumericFormat, __spreadValues({ displayType: "text", value }, others));
}
