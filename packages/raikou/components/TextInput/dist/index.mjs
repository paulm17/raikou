...
function useInputProps(component, defaultProps9, _props) {
  const props = useProps(component, defaultProps9, _props);
  const _a = props, {
    label,
    description,
    error,
...
var TextInput = factory((props, ref) => {
  const _props = useProps("TextInput", defaultProps8, props);
