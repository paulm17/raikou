...
function useInputProps(component, defaultProps9, _props) {
  const props = (0, import_core7.useProps)(component, defaultProps9, _props);
  const _a = props, {
    label,
    description,
    error,
...
// src/TextInput.tsx
var defaultProps8 = {};
var TextInput = (0, import_core9.factory)((props, ref) => {
  const _props = (0, import_core9.useProps)("TextInput", defaultProps8, props);
