...
var Fieldset = (0, import_core.factory)((_props, ref) => {
  const props = (0, import_core.useProps)("Fieldset", defaultProps, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    legend && /* @__PURE__ */ import_react.default.createElement("legend", __spreadValues({}, getStyles("legend", { variant })), legend),
    children
  );
});
