...
import { BoxProps, StylesApiProps, ElementProps, Factory, CompoundStylesApiProps, PolymorphicFactory, RaikouSpacing } from '@raikou/core';
...
declare const AppShellSection: (<C = "div">(props: C extends React$1.ElementType<any> ? AppShellSectionProps & {
    component?: C | undefined;
} & Omit<JSX.LibraryManagedAttributes<C, React$1.PropsWithoutRef<React$1.ComponentProps<C>>>, "component" | keyof AppShellSectionProps> & {
    ...
    renderRoot?(props: any): any;
}) => React$1.ReactElement<any, string | React$1.JSXElementConstructor<any>>) & Omit<React$1.FunctionComponent<(AppShellSectionProps & {
    component?: any;
...
declare function CreateAppShellMediaStyles({ navbar, header, aside, footer, padding, }: AppShellMediaStylesProps): null;

export { AppShell, AppShellAside, type AppShellAsideConfiguration, type AppShellAsideProps, type AppShellCssVariables, type AppShellFactory, AppShellFooter, type AppShellFooterConfiguration, type AppShellFooterProps, AppShellHeader, type AppShellHeaderConfiguration, type AppShellHeaderProps, AppShellMain, type AppShellMainProps, AppShellNavbar, type AppShellNavbarConfiguration, type AppShellNavbarProps, type AppShellProps, type AppShellResponsiveSize, AppShellSection, type AppShellSectionProps, type AppShellStylesNames, CreateAppShellMediaStyles };
