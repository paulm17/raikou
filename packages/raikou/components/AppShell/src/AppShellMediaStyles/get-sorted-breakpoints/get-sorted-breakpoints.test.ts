import { DEFAULT_THEME, px } from "@raikou/core";
import { getSortedBreakpoints } from "./get-sorted-breakpoints";

describe("@raikou/core/AppShell/get-sorted-breakpoints", () => {
  it("sorts given breakpoints without theme values", () => {
    expect(
      getSortedBreakpoints(["20em", "10em", "15em"], DEFAULT_THEME)
    ).toStrictEqual([
      { value: "10em", px: 160 },
      { value: "15em", px: 240 },
      { value: "20em", px: 320 },
  ...
  it("sorts given breakpoints with theme values", () => {
    expect(
      getSortedBreakpoints(["sm", "20em", "lg", "15em"], DEFAULT_THEME)
    ).toStrictEqual([
      { value: "15em", px: 240 },
      { value: "20em", px: 320 },
