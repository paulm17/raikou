...
export function assignNavbarVariables({
  ...
  if (navbar?.collapsed?.mobile) {
    ...
    maxMediaStyles[breakpointValue]["--app-shell-navbar-transform"] =
      collapsedNavbarTransform;
