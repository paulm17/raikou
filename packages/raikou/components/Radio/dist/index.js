...
var InlineInput = (0, import_react11.forwardRef)(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ import_react11.default.createElement(
      ...
      /* @__PURE__ */ import_react11.default.createElement("div", __spreadValues({}, getStyles("body")), children, /* @__PURE__ */ import_react11.default.createElement("div", __spreadValues({}, getStyles("labelWrapper")), label && /* @__PURE__ */ import_react11.default.createElement(
        "label",
        ...
        label
      ), description && /* @__PURE__ */ import_react11.default.createElement(Input.Description, __spreadValues({ size }, getStyles("description")), description), error && error !== "boolean" && /* @__PURE__ */ import_react11.default.createElement(Input.Error, __spreadValues({ size }, getStyles("error")), error)))
    );
  }
);
...
// src/RadioGroup/RadioGroup.tsx
var defaultProps7 = {};
var RadioGroup = (0, import_core9.factory)((props, ref) => {
  const _a = (0, import_core9.useProps)("RadioGroup", defaultProps7, props), {
    value,
    defaultValue,
    onChange,
    size,
  ...
  const _name = (0, import_hooks2.useId)(name);
...
var varsResolver6 = (0, import_core10.createVarsResolver)(
  (theme, { size, radius, color }) => ({
    root: {
      ...
      "--radio-radius": (0, import_core10.getRadius)(radius),
      "--radio-color": (0, import_core10.getThemeColor)(color, theme)
    }
  })
);
var Radio = (0, import_core10.factory)((_props, ref) => {
  var _b, _c;
  const props = (0, import_core10.useProps)("Radio", defaultProps8, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react14.default.createElement(
    ...
    /* @__PURE__ */ import_react14.default.createElement(import_core10.Box, __spreadProps(__spreadValues({}, getStyles("inner")), { mod: { "label-position": labelPosition } }), /* @__PURE__ */ import_react14.default.createElement(
      import_core10.Box,
    ...
    ), /* @__PURE__ */ import_react14.default.createElement(Icon, __spreadProps(__spreadValues({}, getStyles("icon")), { "aria-hidden": true })))
  );
});
