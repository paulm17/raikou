...
declare function RadioIcon({ size, style, ...others }: RadioIconProps): React$1.JSX.Element;
...
type RadioGroupStylesNames = InputWrapperStylesNames;
interface RadioGroupProps extends Omit<InputWrapperProps, "onChange"> {
    /** `Radio` components */
...
declare const RadioGroup: _raikou_core.RaikouComponent<{
    props: RadioGroupProps;
    ref: HTMLDivElement;
    stylesNames: RadioGroupStylesNames;
}>;
...
interface RadioProps extends BoxProps, StylesApiProps<RadioFactory>, ElementProps<"input", "size"> {
    /** Radio label */
    label?: React$1.ReactNode;
