...
function useProps(component, defaultProps8, props) {
  ...
  return { ...defaultProps8, ...contextProps, ...filterProps(props) };
}
...
// ../Loader/src/loaders/Bars.tsx
var Bars = (0, import_react6.forwardRef)(
  ({ className, ...others }, ref) => /* @__PURE__ */ import_react6.default.createElement(
    Box,
    {
      component: "span",
    ...
    /* @__PURE__ */ import_react6.default.createElement("span", { className: "bar" }),
    /* @__PURE__ */ import_react6.default.createElement("span", { className: "bar" }),
    /* @__PURE__ */ import_react6.default.createElement("span", { className: "bar" })
  )
);
...
var Oval = (0, import_react7.forwardRef)(
  ({ className, ...others }, ref) => /* @__PURE__ */ import_react7.default.createElement(
    Box,
    {
      component: "span",
...
var Dots = (0, import_react8.forwardRef)(
  ({ className, ...others }, ref) => /* @__PURE__ */ import_react8.default.createElement(
    Box,
    {
      component: "span",
...
var Text = polymorphicFactory((_props, ref) => {
  const props = useProps("Text", defaultProps2, _props);
  const {
    lineClamp,
    truncate,
    inline,
...
var CloseIcon = (0, import_react11.forwardRef)(
  ({ size = "var(--cb-icon-size)", style, ...others }, ref) => /* @__PURE__ */ import_react11.default.createElement(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var Notification = factory((_props, ref) => {
  const props = useProps("Notification", defaultProps7, _props);
  const {
    className,
    color,
    radius,
  ...
  return /* @__PURE__ */ import_react16.default.createElement(
    ...
    icon && !loading && /* @__PURE__ */ import_react16.default.createElement("div", { ...getStyles("icon") }, icon),
    loading && /* @__PURE__ */ import_react16.default.createElement(Loader, { size: 28, color, ...getStyles("loader") }),
    /* @__PURE__ */ import_react16.default.createElement("div", { ...getStyles("body") }, title && /* @__PURE__ */ import_react16.default.createElement(Text, { ...getStyles("title"), size: "sm", fw: 500 }, title), /* @__PURE__ */ import_react16.default.createElement(
      Text,
      {
    ...
    withCloseButton && /* @__PURE__ */ import_react16.default.createElement(
      CloseButton,
      {
        iconSize: 16,
        color: "gray",
