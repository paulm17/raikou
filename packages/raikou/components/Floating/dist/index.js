...
var import_react57 = require("@floating-ui/react");
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react56.useState)(0);
  (0, import_react56.useEffect)(() => {
    if (floating.refs.reference.current && floating.refs.floating.current) {
      return (0, import_react57.autoUpdate)(
...
var _Box = (0, import_react60.forwardRef)(
  ({ component, style, __vars, className, variant, mod, size, ...others }, ref) => {
    ...
    return /* @__PURE__ */ import_react60.default.createElement(import_react60.default.Fragment, null, parsedStyleProps.hasResponsiveStyles && /* @__PURE__ */ import_react60.default.createElement(
      InlineStyles,
      {
...
// src/FloatingArrow/FloatingArrow.tsx
var FloatingArrow = (0, import_react63.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
