...
import { RaikouRadius, RaikouSize, BoxProps, StylesApiProps, PolymorphicFactory } from '@raikou/core';
...
declare const InputBase: (<C = "input">(props: C extends React$1.ElementType<any> ? InputBaseProps & {
    component?: C | undefined;
} & Omit<JSX.LibraryManagedAttributes<C, React$1.PropsWithoutRef<React$1.ComponentProps<C>>>, "component" | keyof InputBaseProps> & {
...
}) => React$1.ReactElement<any, string | React$1.JSXElementConstructor<any>>) & Omit<React$1.FunctionComponent<(InputBaseProps & {
    component?: any;
