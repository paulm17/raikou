...
function useProps(component, defaultProps8, props) {
  var _a;
  const theme = DEFAULT_THEME;
  const contextPropsPayload = (_a = theme.components[component]) == null ? void 0 : _a.defaultProps;
  const contextProps = typeof contextPropsPayload === "function" ? contextPropsPayload(theme) : contextPropsPayload;
  return __spreadValues(__spreadValues(__spreadValues({}, defaultProps8), contextProps), filterProps(props));
}
...
function useInputProps(component, defaultProps8, _props) {
  const props = useProps(component, defaultProps8, _props);
  const _a = props, {
    label,
    description,
    error,
