...
type ElementType = keyof JSX.IntrinsicElements | React$1.JSXElementConstructor<any>;
type PropsOf<C extends ElementType> = JSX.LibraryManagedAttributes<C, React$1.ComponentPropsWithoutRef<C>>;
type ComponentProp<C> = {
    component?: C;
};
type InheritedProps<C extends ElementType, Props = {}> = ExtendedProps<PropsOf<C>, Props>;
type PolymorphicRef<C> = C extends React$1.ElementType ? React$1.ComponentPropsWithRef<C>["ref"] : never;
type PolymorphicComponentProps<C, Props = {}> = C extends React$1.ElementType ? InheritedProps<C, Props & ComponentProp<C>> & {
...
declare const Badge: (<C = "div">(props: PolymorphicComponentProps<C, BadgeProps>) => React$1.ReactElement<any, string | React$1.JSXElementConstructor<any>>) & Omit<React$1.FunctionComponent<(BadgeProps & {
    component?: any;
...
export { Badge, type BadgeCssVariables, type BadgeFactory, type BadgeProps, type BadgeStylesNames, type BadgeVariant };
