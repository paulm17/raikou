...
return target;};import React from"react";import{Box,factory,useProps}from"@raikou/core";var defaultProps={};var Space=factory((props,ref)=>{const _a=useProps("Space",defaultProps,props),{w,h,miw,mih}=_a,others=__objRest(_a,["w","h","miw","mih"]);return React.createElement(Box,__spreadProps(__spreadValues({ref},others),{w,miw:miw!=null?miw:w,h,mih:mih!=null?mih:h}));});Space.displayName="@raikou/core/Space";export{Space};