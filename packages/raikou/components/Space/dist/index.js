...
return to;};var __toESM=(mod,isNodeMode,target)=>(target=mod!=null?__create(__getProtoOf(mod)):{},__copyProps(isNodeMode||!mod||!mod.__esModule?__defProp(target,"default",{value:mod,enumerable:true}):target,mod));var __toCommonJS=(mod)=>__copyProps(__defProp({},"__esModule",{value:true}),mod);var src_exports={};__export(src_exports,{Space:()=>Space});module.exports=__toCommonJS(src_exports);var import_react=__toESM(require("react"));var import_core=require("@raikou/core");var defaultProps={};var Space=(0,import_core.factory)((props,ref)=>{const _a=(0,import_core.useProps)("Space",defaultProps,props),{w,h,miw,mih}=_a,others=__objRest(_a,["w","h","miw","mih"]);return import_react.default.createElement(import_core.Box,__spreadProps(__spreadValues({ref},others),{w,miw:miw!=null?miw:w,h,mih:mih!=null?mih:h}));});Space.displayName="@raikou/core/Space";0&&(module.exports={Space});