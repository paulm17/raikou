...
var varsResolver = (0, import_core.createVarsResolver)(
  (theme, { color, iconSize, radius }) => {
    const darkParsed = (0, import_core.parseThemeColor)({
      color: color || theme.primaryColor,
      theme,
      colorScheme: "dark"
    });
    const lightParsed = (0, import_core.parseThemeColor)({
      color: color || theme.primaryColor,
      theme,
      colorScheme: "light"
    });
    return {
      root: {
        "--bq-bg-light": (0, import_core.rgba)(lightParsed.value, 0.07),
        "--bq-bg-dark": (0, import_core.rgba)(darkParsed.value, 0.06),
        "--bq-bd": (0, import_core.getThemeColor)(color, theme),
        "--bq-icon-size": (0, import_core.rem)(iconSize),
        "--bq-radius": (0, import_core.getRadius)(radius)
      }
    };
  }
);
var Blockquote = (0, import_core.factory)((_props, ref) => {
  const props = (0, import_core.useProps)("Blockquote", defaultProps, _props);
  const _a = props, {
    classNames,
    className,
    style,
