...
var InputLabel = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(
    ...
    children,
    required && /* @__PURE__ */ React6.createElement("span", __spreadProps(__spreadValues({}, getStyles("required")), { "aria-hidden": true }), " *")
  );
});
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _label = label && /* @__PURE__ */ React11.createElement(
    InputLabel,
    __spreadValues(__spreadValues({
      key: "label",
      labelElement,
  ...
  const _description = hasDescription && /* @__PURE__ */ React11.createElement(
    InputDescription,
  ...
  const _input = /* @__PURE__ */ React11.createElement(React11.Fragment, { key: "input" }, inputContainer(children));
  const _error = hasError && /* @__PURE__ */ React11.createElement(
    InputError,
...
var Input = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React12.createElement(
    ...
    leftSection && /* @__PURE__ */ React12.createElement(
      "div",
    ...
    rightSection && /* @__PURE__ */ React12.createElement(
      "div",
...
var InputBase = polymorphicFactory((props, ref) => {
  ...
  return /* @__PURE__ */ React13.createElement(Input.Wrapper, __spreadValues({}, wrapperProps), /* @__PURE__ */ React13.createElement(Input, __spreadProps(__spreadValues(__spreadValues({}, inputProps), others), { ref })));
});
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => /* @__PURE__ */ React15.createElement(NativeSelectOption, { key: item.value, data: item }));
    return /* @__PURE__ */ React15.createElement("optgroup", { label: data.group }, items);
  }
  const _a = data, { value, label } = _a, others = __objRest(_a, ["value", "label"]);
  return /* @__PURE__ */ React15.createElement("option", __spreadValues({ key: data.value, value: data.value }, others), data.label);
}
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index) => /* @__PURE__ */ React16.createElement(NativeSelectOption, { key: index, data: item }));
  return /* @__PURE__ */ React16.createElement(
    ...
    __spreadProps(__spreadValues({
      ...
      pointer: true,
      error,
      rightSection: rightSection || /* @__PURE__ */ React16.createElement(ComboboxChevron, { size, error })
    }),
    children || options
  );
});
