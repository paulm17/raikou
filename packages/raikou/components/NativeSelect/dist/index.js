...
function useProps(component, defaultProps10, props) {
  var _a;
  const theme = DEFAULT_THEME;
  const contextPropsPayload = (_a = theme.components[component]) == null ? void 0 : _a.defaultProps;
  const contextProps = typeof contextPropsPayload === "function" ? contextPropsPayload(theme) : contextPropsPayload;
  return __spreadValues(__spreadValues(__spreadValues({}, defaultProps10), contextProps), filterProps(props));
}
...
var InputLabel = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ import_react8.default.createElement(
    ...
    children,
    required && /* @__PURE__ */ import_react8.default.createElement("span", __spreadProps(__spreadValues({}, getStyles("required")), { "aria-hidden": true }), " *")
  );
});
...
var InputError = factory((_props, ref) => {
  const props = useProps("InputError", defaultProps2, _props);
  const _a = props, {
    classNames,
    className,
    style,
...
var InputDescription = factory(
  (_props, ref) => {
    const props = useProps("InputDescription", defaultProps3, _props);
    const _a = useProps("InputDescription", defaultProps3, props), {
      classNames,
      className,
      style,
      styles,
...
var defaultProps4 = {};
var InputPlaceholder = factory(
  (_props, ref) => {
    const props = useProps("InputPlaceholder", defaultProps4, _props);
    const _a = useProps("InputPlaceholder", defaultProps4, props), {
      classNames,
      className,
      style,
      styles,
...
var useIsomorphicEffect = typeof document !== "undefined" ? import_react20.useLayoutEffect : import_react20.useEffect;
var __useId = import_react27.default["useId".toString()] || (() => void 0);
function useReactId() {
  const id = __useId();
...
function useId(staticId) {
  ...
  const [uuid, setUuid] = (0, import_react26.useState)(reactId);
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
var InputWrapper = factory((_props, ref) => {
  const props = useProps("InputWrapper", defaultProps5, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  const _label = label && /* @__PURE__ */ import_react66.default.createElement(
    InputLabel,
    __spreadValues(__spreadValues({
      key: "label",
      labelElement,
  ...
  const _description = hasDescription && /* @__PURE__ */ import_react66.default.createElement(
    InputDescription,
  ...
  const _input = /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, { key: "input" }, inputContainer(children));
  const _error = hasError && /* @__PURE__ */ import_react66.default.createElement(
    InputError,
...
var varsResolver5 = createVarsResolver((_, props, ctx) => ({
  wrapper: {
...
var Input = polymorphicFactory((_props, ref) => {
  const props = useProps("Input", defaultProps6, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react67.default.createElement(
    ...
    leftSection && /* @__PURE__ */ import_react67.default.createElement(
      "div",
    ...
    rightSection && /* @__PURE__ */ import_react67.default.createElement(
      "div",
...
function useInputProps(component, defaultProps10, _props) {
  const props = useProps(component, defaultProps10, _props);
  const _a = props, {
    label,
    description,
    error,
...
var InputBase = polymorphicFactory((props, ref) => {
  ...
  return /* @__PURE__ */ import_react68.default.createElement(Input.Wrapper, __spreadValues({}, wrapperProps), /* @__PURE__ */ import_react68.default.createElement(Input, __spreadProps(__spreadValues(__spreadValues({}, inputProps), others), { ref })));
});
...
var ComboboxChevron = factory(
  (_props, ref) => {
    const props = useProps("ComboboxChevron", defaultProps8, _props);
    const _a = props, {
      size,
      error,
      style,
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => /* @__PURE__ */ import_react70.default.createElement(NativeSelectOption, { key: item.value, data: item }));
    return /* @__PURE__ */ import_react70.default.createElement("optgroup", { label: data.group }, items);
  }
  const _a = data, { value, label } = _a, others = __objRest(_a, ["value", "label"]);
  return /* @__PURE__ */ import_react70.default.createElement("option", __spreadValues({ key: data.value, value: data.value }, others), data.label);
}
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index) => /* @__PURE__ */ import_react71.default.createElement(NativeSelectOption, { key: index, data: item }));
  return /* @__PURE__ */ import_react71.default.createElement(
    ...
    __spreadProps(__spreadValues({
      ...
      pointer: true,
      error,
      rightSection: rightSection || /* @__PURE__ */ import_react71.default.createElement(ComboboxChevron, { size, error })
    }),
    children || options
  );
});
