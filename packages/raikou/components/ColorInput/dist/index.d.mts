...
import { RaikouSize, RaikouRadius, StylesApiProps, Factory, RaikouShadow, BoxProps, ElementProps } from '@raikou/core';
...
type ColorInputStylesNames = "dropdown" | "eyeDropperButton" | "eyeDropperIcon" | "colorPreview" | ColorPickerStylesNames | __InputStylesNames;
type ColorInputCssVariables = {
    eyeDropperIcon: "--ci-eye-dropper-icon-size";
    colorPreview: "--ci-preview-size";
};
interface ColorInputProps extends BoxProps, __BaseInputProps, __ColorPickerProps, StylesApiProps<ColorInputFactory>, ElementProps<"input", "size" | "onChange" | "value" | "defaultValue"> {
    ...
    eyeDropperIcon?: React$2.ReactNode;
...
type ColorInputFactory = Factory<{
...
declare const ColorInput: _raikou_core.RaikouComponent<{
    props: ColorInputProps;
    ref: HTMLInputElement;
    stylesNames: ColorInputStylesNames;
    vars: ColorInputCssVariables;
