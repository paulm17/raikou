...
function getStyle({
  ...
  return {
    ...
    ...resolveVars({ theme, props, stylesCtx, vars, varsResolver: varsResolver6, selector, themeName }),
...
var InputLabel = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ import_react8.default.createElement(
    ...
    children,
    required && /* @__PURE__ */ import_react8.default.createElement("span", { ...getStyles("required"), "aria-hidden": true }, " *")
  );
});
...
var InputDescription = factory(
  (_props, ref) => {
    ...
    const {
      ...
      variant,
      ...others
    } = useProps("InputDescription", defaultProps3, props);
    const ctx = useInputWrapperContext();
    const _getStyles = useStyles({
      name: ["InputWrapper", __staticSelector],
      props,
...
var InputPlaceholder = factory(
  (_props, ref) => {
    ...
    const {
      ...
      variant,
      ...others
    } = useProps("InputPlaceholder", defaultProps4, props);
...
var InlineInput = (0, import_react68.forwardRef)(
  ({
    ...
    return /* @__PURE__ */ import_react68.default.createElement(
      ...
      /* @__PURE__ */ import_react68.default.createElement("div", { ...getStyles("body") }, children, /* @__PURE__ */ import_react68.default.createElement("div", { ...getStyles("labelWrapper") }, label && /* @__PURE__ */ import_react68.default.createElement(
        "label",
        {
          ...getStyles("label"),
        ...
        label
      ), description && /* @__PURE__ */ import_react68.default.createElement(Input.Description, { size, ...getStyles("description") }, description), error && error !== "boolean" && /* @__PURE__ */ import_react68.default.createElement(Input.Error, { size, ...getStyles("error") }, error)))
    );
  }
);
