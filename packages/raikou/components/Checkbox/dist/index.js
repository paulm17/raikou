...
var InputLabel = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ import_react62.default.createElement(
    ...
    children,
    required && /* @__PURE__ */ import_react62.default.createElement("span", __spreadProps(__spreadValues({}, getStyles("required")), { "aria-hidden": true }), " *")
  );
});
...
// ../InlineInput/src/InlineInput.tsx
var InlineInput = (0, import_react68.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
      __staticSelector,
      __stylesApiProps,
    ...
    return /* @__PURE__ */ import_react68.default.createElement(
      ...
      /* @__PURE__ */ import_react68.default.createElement("div", __spreadValues({}, getStyles("body")), children, /* @__PURE__ */ import_react68.default.createElement("div", __spreadValues({}, getStyles("labelWrapper")), label && /* @__PURE__ */ import_react68.default.createElement(
        "label",
        ...
        label
      ), description && /* @__PURE__ */ import_react68.default.createElement(Input.Description, __spreadValues({ size }, getStyles("description")), description), error && error !== "boolean" && /* @__PURE__ */ import_react68.default.createElement(Input.Error, __spreadValues({ size }, getStyles("error")), error)))
    );
  }
);
...
var CheckboxGroupContext = (0, import_react69.createContext)(
  null
);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react69.useContext)(CheckboxGroupContext);

// src/CheckboxGroup/CheckboxGroup.tsx
var import_react70 = __toESM(require("react"));
var defaultProps7 = {};
var CheckboxGroup = factory((props, ref) => {
  const _a = useProps("CheckboxGroup", defaultProps7, props), {
    value,
    defaultValue,
    onChange,
    size,
...
function CheckboxIcon(_a) {
  ...
  if (indeterminate) {
    return /* @__PURE__ */ import_react71.default.createElement(
      ...
      /* @__PURE__ */ import_react71.default.createElement("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
    );
  }
  return /* @__PURE__ */ import_react71.default.createElement(CheckIcon, __spreadValues({}, others));
}
...
var Checkbox = factory((_props, ref) => {
  const props = useProps("Checkbox", defaultProps8, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react72.default.createElement(
    ...
    /* @__PURE__ */ import_react72.default.createElement(
      ...
      /* @__PURE__ */ import_react72.default.createElement(Icon, __spreadValues({ indeterminate }, getStyles("icon")))
    )
  );
});
