...
// src/use-collapse.ts
import { useState as useState32, useRef as useRef26 } from "react";
...
function useCollapse({
  ...
  const [styles, setStylesRaw] = useState32(
...
var Collapse = forwardRef4(
  (props, ref) => {
    ...
    if (duration === 0) {
      return opened ? /* @__PURE__ */ React5.createElement(Box, { ...others }, children) : null;
    }
