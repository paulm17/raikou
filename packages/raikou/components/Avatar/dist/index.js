...
var AvatarGroupContext = (0, import_react6.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react6.useContext)(AvatarGroupContext);
...
var AvatarGroup = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ import_react7.default.createElement(AvatarGroupProvider, { value: true }, /* @__PURE__ */ import_react7.default.createElement(Box, __spreadValues(__spreadValues({ ref }, getStyles("root")), others)));
});
...
var Avatar = polymorphicFactory((_props, ref) => {
  const props = useProps("Avatar", defaultProps2, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  const [error, setError] = (0, import_react9.useState)(!src);
  const getStyles = useStyles({
    name: "Avatar",
    props,
    classes: {
  ...
  (0, import_react9.useEffect)(() => setError(!src), [src]);
  return /* @__PURE__ */ import_react9.default.createElement(
    ...
    error ? /* @__PURE__ */ import_react9.default.createElement("span", __spreadProps(__spreadValues({}, getStyles("placeholder")), { title: alt }), children || /* @__PURE__ */ import_react9.default.createElement(AvatarPlaceholderIcon, null)) : /* @__PURE__ */ import_react9.default.createElement(
      "img",
