...
var AvatarGroup = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(AvatarGroupProvider, { value: true }, /* @__PURE__ */ React4.createElement(Box, __spreadValues(__spreadValues({ ref }, getStyles("root")), others)));
});
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(
    ...
    error ? /* @__PURE__ */ React6.createElement("span", __spreadProps(__spreadValues({}, getStyles("placeholder")), { title: alt }), children || /* @__PURE__ */ React6.createElement(AvatarPlaceholderIcon, null)) : /* @__PURE__ */ React6.createElement(
      "img",
