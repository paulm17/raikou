...
import { RaikouSize as RaikouSize$1, RaikouRadius, BoxProps, CompoundStylesApiProps, ElementProps as ElementProps$1, Factory, StylesApiProps, PolymorphicFactory, RaikouShadow } from '@raikou/core';
...
type ComboboxChevronStylesNames = "chevron";
...
declare function TagsInputScroller({ tags, children, maxHeight, }: tagsInputScrollerProps): React$2.JSX.Element;
...
interface TagsInputProps extends BoxProps, __BaseInputProps, Omit<ComboboxLikeProps, "data">, StylesApiProps<TagsInputFactory>, ElementProps$1<"input", "size" | "value" | "defaultValue" | "onChange"> {
    ...
    clearButtonProps?: __CloseButtonProps & ElementProps$1<"button">;
    /** Props passed down to the hidden input */
    hiddenInputProps?: Omit<React$2.ComponentPropsWithoutRef<"input">, "value">;
    /** Divider used to separate values in the hidden input `value` attribute, `','` by default */
    hiddenInputValuesDivider?: string;
    /** A function to render content of the option, replaces the default content of the option */
    renderOption?: (input: ComboboxLikeRenderOptionInput<ComboboxStringItem>) => React$2.ReactNode;
...
declare const TagsInput: _raikou_core.RaikouComponent<{
    props: TagsInputProps;
    ref: HTMLInputElement;
    stylesNames: TagsInputStylesNames;
}>;
