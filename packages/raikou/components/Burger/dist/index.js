...
var Burger = factory((_props, ref) => {
  const props = useProps("Burger", defaultProps2, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ import_react7.default.createElement(UnstyledButton, { ...getStyles("root"), ref, ...others }, /* @__PURE__ */ import_react7.default.createElement(Box, { mod: ["reduce-motion", { opened }], ...getStyles("burger") }), children);
});
