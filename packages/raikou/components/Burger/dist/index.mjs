...
var Burger = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(UnstyledButton, { ...getStyles("root"), ref, ...others }, /* @__PURE__ */ React5.createElement(Box, { mod: ["reduce-motion", { opened }], ...getStyles("burger") }), children);
});
