...
import { factory as factory13, useProps as useProps16 } from "@raikou/core";
...
var ComboboxSearch = factory13((_props, ref) => {
  const props = useProps16("ComboboxSearch", defaultProps16, _props);
  const _a = props, {
    classNames,
    styles,
    unstyled,
...
import { isElement as isElement6, useProps as useProps20, factory as factory17 } from "@raikou/core";
var defaultProps20 = {
  refProp: "ref",
  targetType: "input",
  withKeyboardNavigation: true,
...
var ComboboxEventsTarget = factory17(
  (props, ref) => {
    const _a = useProps20("ComboboxEventsTarget", defaultProps20, props), {
      children,
      refProp,
      withKeyboardNavigation,
      withAriaAttributes,
...
import { isElement as isElement7, useProps as useProps21, factory as factory18 } from "@raikou/core";
var defaultProps21 = {
  refProp: "ref"
};
var ComboboxDropdownTarget = factory18(
  (props, ref) => {
    const { children, refProp } = useProps21(
...
var ComboboxGroup = factory19((props, ref) => {
  const _a = useProps22("ComboboxGroup", defaultProps22, props), {
    classNames,
    className,
    style,
    styles,
...
var UnstyledButton = polymorphicFactory2(
  (_props, ref) => {
    const props = useProps23("UnstyledButton", defaultProps23, _props);
    const _a = props, {
      className,
      component = "button",
      __staticSelector,
...
var CloseButton = polymorphicFactory3(
  (_props, ref) => {
    const props = useProps24("CloseButton", defaultProps24, _props);
    const _a = props, {
      iconSize,
      children,
      vars,
...
function Combobox(_props) {
  const props = useProps25("Combobox", defaultProps25, _props);
  const _a = props, {
    classNames,
    styles,
    unstyled,
...
import { Box as Box16, useProps as useProps26 } from "@raikou/core";
var defaultProps26 = {
  scrollHideDelay: 1e3,
  type: "hover"
};
var ScrollAreaRoot = forwardRef13(
  (_props, ref) => {
    const props = useProps26("ScrollAreaRoot", defaultProps26, _props);
...
var ScrollArea = factory20((_props, ref) => {
  const props = useProps27("ScrollArea", defaultProps27, _props);
  const _a = props, {
    classNames,
    className,
    style,
...
var ScrollAreaAutosize = factory20((props, ref) => {
  const _a = useProps27("ScrollAreaAutosize", defaultProps27, props), {
    children,
    classNames,
    styles,
    scrollbarSize,
...
import { useCallback as useCallback5, useEffect as useEffect15, useRef as useRef12 } from "react";
...
function useVirtualizedCombobox({
  ...
  const [dropdownOpened, setDropdownOpened] = useUncontrolled3({
    value: opened,
    defaultValue: defaultOpened,
    finalValue: false,
    onChange: onOpenedChange
  });
  const listId = useRef12(null);
  const searchRef = useRef12(null);
  const targetRef = useRef12(null);
  const focusSearchTimeout = useRef12(-1);
  const focusTargetTimeout = useRef12(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = useCallback5(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
