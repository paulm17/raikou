...
function useCallbackRef(callback) {
  ...
  return (0, import_react7.useMemo)(() => (...args) => {
    var _a;
...
function useDebounceCallback(callback, delay) {
  ...
  (0, import_react8.useEffect)(() => () => window.clearTimeout(debounceTimerRef.current), []);
...
function useFocusTrap(active = true) {
  ...
  const restoreAria = (0, import_react19.useRef)(null);
  ...
  const setRef = (0, import_react19.useCallback)(
    (node) => {
      if (!active) {
        return;
      }
...
function useMergedRef(...refs) {
  return (0, import_react28.useCallback)(mergeRefs(...refs), refs);
}
...
function createSafeContext(errorMessage) {
  const Context = (0, import_react67.createContext)(null);
  const useSafeContext = () => {
    const ctx = (0, import_react67.useContext)(Context);
    if (ctx === null) {
      throw new Error(errorMessage);
    }
    return ctx;
  };
  const Provider = ({ children, value }) => /* @__PURE__ */ import_react67.default.createElement(Context.Provider, { value }, children);
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react69.cloneElement)(children, __spreadValues(__spreadProps(__spreadValues(__spreadValues(__spreadValues({}, forwardedProps), accessibleProps), ctx.targetProps), {
...
var defaultProps3 = {};
var Portal = (0, import_react70.forwardRef)((props, ref) => {
  const _a = useProps(
    "Portal",
    defaultProps3,
    props
  ...
  return (0, import_react_dom4.createPortal)(
    /* @__PURE__ */ import_react70.default.createElement("div", __spreadValues({ className, ref }, others), children),
    nodeRef.current
  );
});
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react71.default.createElement(Portal, __spreadValues({}, others), children);
  }
  return /* @__PURE__ */ import_react71.default.createElement(import_react71.default.Fragment, null, children);
}
...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react72.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react72.useState)(
    mounted ? "entered" : "exited"
  );
  const timeoutRef = (0, import_react72.useRef)(-1);
  ...
  (0, import_react72.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react73.default.createElement(import_react73.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react73.default.createElement(import_react73.default.Fragment, null, children(
    getTransitionStyles({
      transition,
...
function FocusTrap({
  ...
  return (0, import_react74.cloneElement)(children, { [refProp]: ref });
}
...
var PopoverDropdown = factory(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ import_react75.default.createElement(OptionalPortal, __spreadProps(__spreadValues({}, ctx.portalProps), { withinPortal: ctx.withinPortal }), /* @__PURE__ */ import_react75.default.createElement(
      Transition,
      ...
      (transitionStyles) => {
        var _a2, _b2;
        return /* @__PURE__ */ import_react75.default.createElement(FocusTrap, { active: ctx.trapFocus }, /* @__PURE__ */ import_react75.default.createElement(
          Box,
...
function Popover(_props) {
  ...
  const reference = (0, import_react76.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react76.useCallback)(
    (node) => {
...
function useCombobox({
  ...
  const listId = (0, import_react77.useRef)(null);
  const selectedOptionIndex = (0, import_react77.useRef)(-1);
  const searchRef = (0, import_react77.useRef)(null);
  const targetRef = (0, import_react77.useRef)(null);
  const focusSearchTimeout = (0, import_react77.useRef)(-1);
  const focusTargetTimeout = (0, import_react77.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react77.useRef)(-1);
  const openDropdown = (0, import_react77.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react77.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react77.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react77.useCallback)(() => {
  ...
  const selectOption = (0, import_react77.useCallback)(
    (index3) => {
  ...
  const selectActiveOption = (0, import_react77.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react77.useCallback)(
    () => selectOption(
      getNextIndex(
  ...
  const selectPreviousOption = (0, import_react77.useCallback)(
    () => selectOption(
      getPreviousIndex(
        selectedOptionIndex.current,
        document.querySelectorAll(
  ...
  const selectFirstOption = (0, import_react77.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(
          `#${listId.current} [data-combobox-option]`
  ...
  const updateSelectedOptionIndex = (0, import_react77.useCallback)(
    (target = "selected") => {
  ...
  const resetSelectedOption = (0, import_react77.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react77.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react77.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react77.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(
      () => searchRef.current.focus(),
      0
    );
  }, []);
  const focusTarget = (0, import_react77.useCallback)(() => {
...
function useComboboxTargetProps({
  ...
  const [selectedOptionId, setSelectedOptionId] = (0, import_react78.useState)(null);
  const handleKeyDown = (event) => {
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react79.cloneElement)(children, __spreadValues(__spreadValues({}, targetProps), others));
  return /* @__PURE__ */ import_react79.default.createElement(Popover.Target, { ref: useMergedRef(ref, ctx.store.targetRef) }, clonedElement);
});
...
function factory2(ui) {
  const Component = (0, import_react87.forwardRef)(ui);
  Component.extend = identity2;
  return Component;
}
function polymorphicFactory(ui) {
  const Component = (0, import_react88.forwardRef)(ui);
  Component.extend = identity2;
  return Component;
}
...
var _Box2 = (0, import_react86.forwardRef)(
  (_a, ref) => {
    var _b = _a, { component, style, __vars, className, variant, mod, size: size2 } = _b, others = __objRest(_b, ["component", "style", "__vars", "className", "variant", "mod", "size"]);
    const theme = getTheme2();
    const Element = component || "div";
    ...
    return /* @__PURE__ */ import_react86.default.createElement(import_react86.default.Fragment, null, parsedStyleProps.hasResponsiveStyles && /* @__PURE__ */ import_react86.default.createElement(
      InlineStyles2,
      {
        selector: `.${responsiveClassName}`,
        styles: parsedStyleProps.styles,
...
function createOptionalContext2(initialValue = null) {
  const Context = (0, import_react90.createContext)(initialValue);
  const useOptionalContext = () => (0, import_react90.useContext)(Context);
  const Provider = ({ children, value }) => /* @__PURE__ */ import_react90.default.createElement(Context.Provider, { value }, children);
...
var InputLabel = factory2((_props, ref) => {
  ...
  return /* @__PURE__ */ import_react91.default.createElement(
    ...
    children,
    required && /* @__PURE__ */ import_react91.default.createElement("span", __spreadProps(__spreadValues({}, getStyles("required")), { "aria-hidden": true }), " *")
  );
});
...
var useIsomorphicEffect2 = typeof document !== "undefined" ? import_react104.useLayoutEffect : import_react104.useEffect;
var __useId2 = import_react111.default["useId".toString()] || (() => void 0);
...
function useId3(staticId) {
  ...
  const [uuid, setUuid] = (0, import_react110.useState)(reactId);
...
var InputWrapper = factory2((_props, ref) => {
  ...
  const _label = label && /* @__PURE__ */ import_react95.default.createElement(
    InputLabel,
    __spreadValues(__spreadValues({
      key: "label",
      labelElement,
  ...
  const _description = hasDescription && /* @__PURE__ */ import_react95.default.createElement(
    InputDescription,
    __spreadProps(__spreadValues(__spreadValues({
      key: "description"
  ...
  const _input = /* @__PURE__ */ import_react95.default.createElement(import_react95.default.Fragment, { key: "input" }, inputContainer(children));
  const _error = hasError && /* @__PURE__ */ import_react95.default.createElement(
    InputError,
...
var ComboboxEventsTarget = factory(
  (props, ref) => {
    ...
    return (0, import_react154.cloneElement)(children, __spreadProps(__spreadValues(__spreadValues({}, targetProps), others), {
...
var ComboboxDropdownTarget = factory(
  (props, ref) => {
    ...
    return /* @__PURE__ */ import_react155.default.createElement(Popover.Target, { ref, refProp }, children);
  }
);
...
var ComboboxGroup = factory((props, ref) => {
  ...
  return /* @__PURE__ */ import_react156.default.createElement(
    ...
    label && /* @__PURE__ */ import_react156.default.createElement("div", __spreadValues({}, ctx.getStyles("groupLabel", { classNames, styles })), label),
    children
  );
});
...
// ../ScrollArea/src/ScrollAreaScrollbar/Scrollbar.tsx
var Scrollbar = (0, import_react158.forwardRef)(
  (props, forwardedRef) => {
    const _a = props, {
      sizes,
      hasThumb,
    ...
    const [scrollbar, setScrollbar] = import_react158.default.useState(
      null
    );
    ...
    const rectRef = import_react158.default.useRef(null);
    const prevWebkitUserSelectRef = import_react158.default.useRef("");
    ...
    (0, import_react158.useEffect)(handleThumbPositionChange, [sizes, handleThumbPositionChange]);
...
// ../ScrollArea/src/ScrollAreaScrollbar/ScrollbarX.tsx
var ScrollAreaScrollbarX = (0, import_react159.forwardRef)((props, forwardedRef) => {
  const _a = props, { sizes, onSizesChange, style } = _a, others = __objRest(_a, ["sizes", "onSizesChange", "style"]);
  const ctx = useScrollAreaContext();
  const [computedStyle, setComputedStyle] = (0, import_react159.useState)();
...
var ScrollAreaScrollbarY = (0, import_react160.forwardRef)((props, forwardedRef) => {
  const _a = props, { sizes, onSizesChange, style } = _a, others = __objRest(_a, ["sizes", "onSizesChange", "style"]);
  const context = useScrollAreaContext();
  const [computedStyle, setComputedStyle] = import_react160.default.useState();
...
// ../ScrollArea/src/ScrollAreaScrollbar/ScrollAreaScrollbarVisible.tsx
var ScrollAreaScrollbarVisible = (0, import_react161.forwardRef)((props, forwardedRef) => {
  ...
  const pointerOffsetRef = (0, import_react161.useRef)(0);
  const [sizes, setSizes] = (0, import_react161.useState)({
    content: 0,
    viewport: 0,
...
var ScrollAreaScrollbarAuto = (0, import_react162.forwardRef)((props, ref) => {
  const context = useScrollAreaContext();
  const _a = props, { forceMount } = _a, scrollbarProps = __objRest(_a, ["forceMount"]);
  const [visible2, setVisible] = (0, import_react162.useState)(false);
...
// ../ScrollArea/src/ScrollAreaScrollbar/ScrollAreaScrollbarHover.tsx
var ScrollAreaScrollbarHover = (0, import_react163.forwardRef)(
  (props, ref) => {
    const _a = props, { forceMount } = _a, scrollbarProps = __objRest(_a, ["forceMount"]);
    const context = useScrollAreaContext();
    const [visible2, setVisible] = (0, import_react163.useState)(false);
...
var ScrollAreaScrollbarScroll = (0, import_react164.forwardRef)((props, red) => {
  const _a = props, { forceMount } = _a, scrollbarProps = __objRest(_a, ["forceMount"]);
  const context = useScrollAreaContext();
  const isHorizontal = props.orientation === "horizontal";
  const [state, setState] = (0, import_react164.useState)("hidden");
...
// ../ScrollArea/src/ScrollAreaScrollbar/ScrollAreaScrollbar.tsx
var ScrollAreaScrollbar = import_react165.default.forwardRef(
  (props, forwardedRef) => {
    const _a = props, { forceMount } = _a, scrollbarProps = __objRest(_a, ["forceMount"]);
    const context = useScrollAreaContext();
    ...
    return context.type === "hover" ? /* @__PURE__ */ import_react165.default.createElement(ScrollAreaScrollbarHover, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef, forceMount })) : context.type === "scroll" ? /* @__PURE__ */ import_react165.default.createElement(ScrollAreaScrollbarScroll, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef, forceMount })) : context.type === "auto" ? /* @__PURE__ */ import_react165.default.createElement(ScrollAreaScrollbarAuto, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef, forceMount })) : context.type === "always" ? /* @__PURE__ */ import_react165.default.createElement(ScrollAreaScrollbarVisible, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef })) : null;
  }
);

// ../ScrollArea/src/ScrollAreaCorner/ScrollAreaCorner.tsx
var import_react166 = __toESM(require("react"));
var Corner = import_react166.default.forwardRef(
  (props, ref) => {
    const _a = props, { style } = _a, others = __objRest(_a, ["style"]);
    const ctx = useScrollAreaContext();
    const [width, setWidth] = import_react166.default.useState(0);
    const [height, setHeight] = import_react166.default.useState(0);
    ...
    return hasSize ? /* @__PURE__ */ import_react166.default.createElement("div", __spreadProps(__spreadValues({}, others), { ref, style: __spreadProps(__spreadValues({}, style), { width, height }) })) : null;
  }
);
var ScrollAreaCorner = import_react166.default.forwardRef((props, ref) => {
  const ctx = useScrollAreaContext();
  const hasBothScrollbarsVisible = Boolean(ctx.scrollbarX && ctx.scrollbarY);
  const hasCorner = ctx.type !== "scroll" && hasBothScrollbarsVisible;
  return hasCorner ? /* @__PURE__ */ import_react166.default.createElement(Corner, __spreadProps(__spreadValues({}, props), { ref })) : null;
});
...
var ScrollAreaRoot = (0, import_react167.forwardRef)(
  (_props, ref) => {
    ...
    const [scrollArea, setScrollArea] = (0, import_react167.useState)(null);
    const [viewport, setViewport] = (0, import_react167.useState)(null);
    const [content, setContent] = (0, import_react167.useState)(null);
    const [scrollbarX, setScrollbarX] = (0, import_react167.useState)(null);
    const [scrollbarY, setScrollbarY] = (0, import_react167.useState)(null);
    const [cornerWidth, setCornerWidth] = (0, import_react167.useState)(0);
    const [cornerHeight, setCornerHeight] = (0, import_react167.useState)(0);
    const [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react167.useState)(false);
    const [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react167.useState)(false);
...
var ScrollAreaViewport = (0, import_react168.forwardRef)((_a, ref) => {
...
var Thumb = (0, import_react169.forwardRef)(
  (props, forwardedRef) => {
    const _a = props, { style } = _a, others = __objRest(_a, ["style"]);
    ...
    const removeUnlinkedScrollListenerRef = (0, import_react169.useRef)();
...
var ScrollAreaThumb = import_react169.default.forwardRef((props, forwardedRef) => {
  const _a = props, { forceMount } = _a, thumbProps = __objRest(_a, ["forceMount"]);
  const scrollbarContext = useScrollbarContext();
  if (forceMount || scrollbarContext.hasThumb) {
    return /* @__PURE__ */ import_react169.default.createElement(Thumb, __spreadValues({ ref: forwardedRef }, thumbProps));
  }
  return null;
});
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react170.useState)(false);
  const getStyles = useStyles({
    name: "ScrollArea",
    props,
    classes: {
  ...
  return /* @__PURE__ */ import_react170.default.createElement(
    ...
    /* @__PURE__ */ import_react170.default.createElement(
      ...
      /* @__PURE__ */ import_react170.default.createElement(ScrollAreaThumb, __spreadValues({}, getStyles("thumb")))
    ),
    /* @__PURE__ */ import_react170.default.createElement(
      ScrollAreaScrollbar,
      __spreadProps(__spreadValues({}, getStyles("scrollbar")), {
...
var ScrollAreaAutosize = factory((props, ref) => {
  ...
  return /* @__PURE__ */ import_react170.default.createElement(Box, __spreadProps(__spreadValues({}, others), { ref, style: [{ display: "flex" }, style] }), /* @__PURE__ */ import_react170.default.createElement(Box, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ import_react170.default.createElement(
    ScrollArea,
    {
      classNames,
      styles,
...
function Option({ data }) {
  if (!isGroup2(data)) {
    return /* @__PURE__ */ import_react171.default.createElement(Combobox.Option, { value: data.value, disabled: data.disabled }, data.label);
  }
  const options = data.items.map((item) => /* @__PURE__ */ import_react171.default.createElement(Option, { data: item, key: item.value }));
  return /* @__PURE__ */ import_react171.default.createElement(Combobox.Group, { label: data.group }, options);
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => /* @__PURE__ */ import_react171.default.createElement(Option, { data: item, key: isGroup2(item) ? item.group : item.value }));
  return /* @__PURE__ */ import_react171.default.createElement(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty }, /* @__PURE__ */ import_react171.default.createElement(Combobox.Options, null, withScrollArea ? /* @__PURE__ */ import_react171.default.createElement(
    ScrollArea.Autosize,
    {
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react172.useRef)(null);
  const searchRef = (0, import_react172.useRef)(null);
  const targetRef = (0, import_react172.useRef)(null);
  const focusSearchTimeout = (0, import_react172.useRef)(-1);
  const focusTargetTimeout = (0, import_react172.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
