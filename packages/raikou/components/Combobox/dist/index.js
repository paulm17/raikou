...
__export(src_exports, {
  ...
  ComboboxClearButton: () => ComboboxClearButton,
...
var ComboboxEmpty = (0, import_core24.factory)((props, ref) => {
  const _a = (0, import_core24.useProps)(
    "ComboboxEmpty",
    defaultProps17,
    props
...
var UnstyledButton = (0, import_core30.polymorphicFactory)(
  (_props, ref) => {
    const props = (0, import_core30.useProps)("UnstyledButton", defaultProps23, _props);
    const _a = props, {
      className,
      component = "button",
      __staticSelector,
...
var varsResolver8 = (0, import_core31.createVarsResolver)(
  (_, { size: size2, radius, iconSize }) => ({
    root: {
      "--cb-size": (0, import_core31.getSize)(size2, "cb-size"),
      "--cb-radius": radius === void 0 ? void 0 : (0, import_core31.getRadius)(radius),
      "--cb-icon-size": (0, import_core31.rem)(iconSize)
    }
  })
);
var CloseButton = (0, import_core31.polymorphicFactory)(
  (_props, ref) => {
    const props = (0, import_core31.useProps)("CloseButton", defaultProps24, _props);
    const _a = props, {
      iconSize,
      children,
      vars,
...
function Combobox(_props) {
  const props = (0, import_core32.useProps)("Combobox", defaultProps25, _props);
  const _a = props, {
    classNames,
    styles,
    unstyled,
...
var ScrollAreaRoot = (0, import_react53.forwardRef)(
  (_props, ref) => {
    const props = (0, import_core34.useProps)("ScrollAreaRoot", defaultProps26, _props);
...
var ScrollArea = (0, import_core36.factory)((_props, ref) => {
  const props = (0, import_core36.useProps)("ScrollArea", defaultProps27, _props);
  const _a = props, {
    classNames,
    className,
    style,
...
var ScrollAreaAutosize = (0, import_core36.factory)((props, ref) => {
  const _a = (0, import_core36.useProps)("ScrollAreaAutosize", defaultProps27, props), {
    children,
    classNames,
    styles,
    scrollbarSize,
  ...
  return /* @__PURE__ */ import_react56.default.createElement(import_core36.Box, __spreadProps(__spreadValues({}, others), { ref, style: [{ display: "flex" }, style] }), /* @__PURE__ */ import_react56.default.createElement(import_core36.Box, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ import_react56.default.createElement(
    ScrollArea,
    {
      classNames,
      styles,
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react59.useRef)(null);
  const searchRef = (0, import_react59.useRef)(null);
  const targetRef = (0, import_react59.useRef)(null);
  const focusSearchTimeout = (0, import_react59.useRef)(-1);
  const focusTargetTimeout = (0, import_react59.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = (0, import_react59.useCallback)(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
