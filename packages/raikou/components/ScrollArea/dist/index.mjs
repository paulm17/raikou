...
// src/ScrollArea.tsx
import React19, { useState as useState38 } from "react";
...
import React10, { useRef as useRef28, useState as useState33, forwardRef as forwardRef7 } from "react";

// src/ScrollAreaScrollbar/ScrollbarX.tsx
import React8, { forwardRef as forwardRef5, useRef as useRef26, useState as useState32, useEffect as useEffect35 } from "react";
...
var __useId = React6["useId".toString()] || (() => void 0);
...
import React7, { useEffect as useEffect34, forwardRef as forwardRef4 } from "react";
...
var Scrollbar = forwardRef4(
  (props, forwardedRef) => {
    ...
    const [scrollbar, setScrollbar] = React7.useState(
      null
    );
    ...
    const rectRef = React7.useRef(null);
    const prevWebkitUserSelectRef = React7.useRef("");
...
import React9, { forwardRef as forwardRef6, useEffect as useEffect36, useRef as useRef27 } from "react";
...
import React12, { forwardRef as forwardRef9, useEffect as useEffect37, useState as useState35 } from "react";

// src/ScrollAreaScrollbar/ScrollAreaScrollbarAuto.tsx
import React11, { forwardRef as forwardRef8, useState as useState34 } from "react";
...
import React13, { forwardRef as forwardRef10, useEffect as useEffect38, useState as useState36 } from "react";
...
// src/ScrollAreaScrollbar/ScrollAreaScrollbar.tsx
var ScrollAreaScrollbar = React14.forwardRef(
  (props, forwardedRef) => {
    const _a = props, { forceMount } = _a, scrollbarProps = __objRest(_a, ["forceMount"]);
    const context = useScrollAreaContext();
    ...
    return context.type === "hover" ? /* @__PURE__ */ React14.createElement(ScrollAreaScrollbarHover, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef, forceMount })) : context.type === "scroll" ? /* @__PURE__ */ React14.createElement(ScrollAreaScrollbarScroll, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef, forceMount })) : context.type === "auto" ? /* @__PURE__ */ React14.createElement(ScrollAreaScrollbarAuto, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef, forceMount })) : context.type === "always" ? /* @__PURE__ */ React14.createElement(ScrollAreaScrollbarVisible, __spreadProps(__spreadValues({}, scrollbarProps), { ref: forwardedRef })) : null;
  }
);

// src/ScrollAreaCorner/ScrollAreaCorner.tsx
import React15 from "react";
var Corner = React15.forwardRef(
  (props, ref) => {
    ...
    return hasSize ? /* @__PURE__ */ React15.createElement("div", __spreadProps(__spreadValues({}, others), { ref, style: __spreadProps(__spreadValues({}, style), { width, height }) })) : null;
  }
);
var ScrollAreaCorner = React15.forwardRef((props, ref) => {
  const ctx = useScrollAreaContext();
  const hasBothScrollbarsVisible = Boolean(ctx.scrollbarX && ctx.scrollbarY);
  const hasCorner = ctx.type !== "scroll" && hasBothScrollbarsVisible;
  return hasCorner ? /* @__PURE__ */ React15.createElement(Corner, __spreadProps(__spreadValues({}, props), { ref })) : null;
});

// src/ScrollAreaRoot/ScrollAreaRoot.tsx
import React16, { useState as useState37, forwardRef as forwardRef11 } from "react";
var defaultProps = {
  scrollHideDelay: 1e3,
  type: "hover"
};
...
import React17, { forwardRef as forwardRef12 } from "react";
...
import React18, { forwardRef as forwardRef13, useRef as useRef29, useEffect as useEffect39 } from "react";
...
var ScrollAreaThumb = React18.forwardRef((props, forwardedRef) => {
  const _a = props, { forceMount } = _a, thumbProps = __objRest(_a, ["forceMount"]);
  const scrollbarContext = useScrollbarContext();
  if (forceMount || scrollbarContext.hasThumb) {
    return /* @__PURE__ */ React18.createElement(Thumb, __spreadValues({ ref: forwardedRef }, thumbProps));
  }
  return null;
});
...
var ScrollArea = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React19.createElement(
    ...
    /* @__PURE__ */ React19.createElement(
      ...
      /* @__PURE__ */ React19.createElement(ScrollAreaThumb, __spreadValues({}, getStyles("thumb")))
    ),
    /* @__PURE__ */ React19.createElement(
      ScrollAreaScrollbar,
      __spreadProps(__spreadValues({}, getStyles("scrollbar")), {
...
var ScrollAreaAutosize = factory((props, ref) => {
  ...
  return /* @__PURE__ */ React19.createElement(Box, __spreadProps(__spreadValues({}, others), { ref, style: [{ display: "flex" }, style] }), /* @__PURE__ */ React19.createElement(Box, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ React19.createElement(
    ScrollArea,
    {
      classNames,
      styles,
