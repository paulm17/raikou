...
import { tests, render, createContextContainer, screen } from "@raikou/tests";
...
describe("@raikou/core/TabsList", () => {
  ...
  it("sets aria-orientation attribute based on context value", () => {
    const Vertical = createContextContainer(TabsList, Tabs, {
      orientation: "vertical",
    });
    const Horizontal = createContextContainer(TabsList, Tabs, {
  ...
  it("sets data-inverted based on context value", () => {
    ...
    const NotInverted = createContextContainer(TabsList, Tabs, {
      inverted: false,
    });
