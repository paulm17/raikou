...
describe("@raikou/core/TabsTab", () => {
  ...
  it("sets data-active attribute to true if tab is active", () => {
    const ActiveContainer = createContextContainer(TabsTab, Tabs, {
      value: "test",
    });
    const InactiveContainer = createContextContainer(TabsTab, Tabs, {
      value: "test2",
    });

    const { rerender } = render(
      <ActiveContainer {...defaultProps} value="test" />
    );
