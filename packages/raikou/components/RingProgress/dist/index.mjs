...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ React4.createElement(React4.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ React4.createElement(React4.Fragment, null, children(
    getTransitionStyles({
      transition,
...
import React5, { useRef as useRef5, useState as useState5, forwardRef as forwardRef3 } from "react";
...
var Portal = forwardRef3((props, ref) => {
  ...
  return createPortal2(/* @__PURE__ */ React5.createElement(React5.Fragment, null, children), nodeRef.current);
});
...
import React7, { cloneElement as cloneElement2 } from "react";
...
function TooltipGroup(props) {
  ...
  return /* @__PURE__ */ React8.createElement(TooltipGroupProvider, { value: true }, /* @__PURE__ */ React8.createElement(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay } }, children));
}
...
var Tooltip = factory2((_props, ref) => {
  ...
  return /* @__PURE__ */ React9.createElement(React9.Fragment, null, /* @__PURE__ */ React9.createElement(OptionalPortal, __spreadProps(__spreadValues({}, portalProps), { withinPortal }), /* @__PURE__ */ React9.createElement(
    Transition,
...
function Curve(_a) {
  ...
  return /* @__PURE__ */ React10.createElement(Tooltip.Floating, { disabled: !tooltip, label: tooltip }, /* @__PURE__ */ React10.createElement(
    ...
    __spreadValues(__spreadProps(__spreadValues(__spreadValues({
      ...
      __vars: {
        "--curve-color": color ? getThemeColor3(color, theme) : void 0
      },
      fill: "none",
...
var varsResolver3 = createVarsResolver3(
  (_, { size: size2, thickness }) => ({
    root: {
      "--rp-size": rem3(size2),
      "--rp-label-offset": rem3(thickness * 2)
    }
  })
);
var RingProgress = factory3((_props, ref) => {
  const props = useProps5("RingProgress", defaultProps5, _props);
  const _a = props, {
    classNames,
    className,
    style,
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index3) => /* @__PURE__ */ React11.createElement(
    Curve,
