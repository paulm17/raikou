...
interface NumberInputProps extends BoxProps, __BaseInputProps, StylesApiProps<NumberInputFactory>, ElementProps<"input", "size" | "type" | "onChange"> {
...
declare const NumberInput: _raikou_core.RaikouComponent<{
    props: NumberInputProps;
    ref: HTMLDivElement;
    stylesNames: NumberInputStylesNames;
    vars: NumberInputCssVariables;
