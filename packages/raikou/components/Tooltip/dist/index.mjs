...
// src/Tooltip.tsx
import React10, { cloneElement as cloneElement2, useRef as useRef29 } from "react";
...
import { useState as useState33, useEffect as useEffect35, useRef as useRef26 } from "react";
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = useState33(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = useState33(
...
import React6, { useRef as useRef27, useState as useState34, forwardRef as forwardRef5 } from "react";
...
var Portal = forwardRef5((props, ref) => {
  ...
  return createPortal(
    /* @__PURE__ */ React6.createElement("div", __spreadValues({ className, ref }, others), children),
    nodeRef.current
  );
});
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ React7.createElement(Portal, __spreadValues({}, others), children);
  }
...
import React8, { cloneElement } from "react";

// src/TooltipFloating/use-floating-tooltip.ts
import { useState as useState35, useEffect as useEffect36, useCallback as useCallback14, useRef as useRef28 } from "react";
import { useFloating, shift, getOverflowAncestors } from "@floating-ui/react";
function useFloatingTooltip({
  offset: offset2,
  position
}) {
  const [opened, setOpened] = useState35(false);
  const boundaryRef = useRef28();
...
var TooltipFloating = factory(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement(OptionalPortal, __spreadProps(__spreadValues({}, portalProps), { withinPortal }), /* @__PURE__ */ React8.createElement(
      Box,
...
function TooltipGroup(props) {
  ...
  return /* @__PURE__ */ React9.createElement(TooltipGroupProvider, { value: true }, /* @__PURE__ */ React9.createElement(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay } }, children));
}
TooltipGroup.displayName = "@raikou/core/TooltipGroup";

// src/use-tooltip.ts
import { useState as useState36, useCallback as useCallback15 } from "react";
import {
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = useState36(false);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const { delay: groupDelay, currentId, setCurrentId } = useDelayGroupContext();
  const onChange = useCallback15(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React10.createElement(React10.Fragment, null, /* @__PURE__ */ React10.createElement(OptionalPortal, __spreadProps(__spreadValues({}, portalProps), { withinPortal }), /* @__PURE__ */ React10.createElement(
    Transition,
    ...
    tooltip.getReferenceProps(__spreadValues({
      ...
      [refProp]: targetRef,
      className: cx5(className, children.props.className)
    }, children.props))
  ));
});
