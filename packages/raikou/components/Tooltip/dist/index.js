...
function isElement(value) {
  ...
  if (typeof value === "object") {
    if (value.type === import_react55.default.Fragment) {
      return false;
    }
    return true;
  }
...
function useFloatingAutoUpdate({
  ...
  (0, import_react60.useEffect)(() => {
    if (floating.refs.reference.current && floating.refs.floating.current) {
      return (0, import_react61.autoUpdate)(
...
// ../Floating/src/FloatingArrow/FloatingArrow.tsx
var FloatingArrow = (0, import_react62.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
      position,
      arrowSize,
...
function useTransition({
  ...
  const [transitionDuration, setTransitionDuration] = (0, import_react63.useState)(
    reduceMotion ? 0 : duration
  );
  const [transitionStatus, setStatus] = (0, import_react63.useState)(
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react64.default.createElement(import_react64.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : /* @__PURE__ */ import_react64.default.createElement(import_react64.default.Fragment, null, children(
    getTransitionStyles({
      transition,
...
var defaultProps = {};
var Portal = (0, import_react65.forwardRef)((props, ref) => {
  const _a = useProps(
    "Portal",
    defaultProps,
    props
  ...
  return (0, import_react_dom.createPortal)(
    /* @__PURE__ */ import_react65.default.createElement("div", __spreadValues({ className, ref }, others), children),
    nodeRef.current
  );
});
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react66.default.createElement(Portal, __spreadValues({}, others), children);
  }
  return /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, null, children);
}
...
var import_react68 = require("@floating-ui/react");
function useFloatingTooltip({
  offset: offset2,
  position
}) {
  const [opened, setOpened] = (0, import_react67.useState)(false);
  const boundaryRef = (0, import_react67.useRef)();
  const { x, y, reference, floating, refs, update, placement } = (0, import_react68.useFloating)({
    placement: position,
    middleware: [
      (0, import_react68.shift)({
        crossAxis: true,
        padding: 5,
  ...
  const handleMouseMove = (0, import_react67.useCallback)(
    ({ clientX, clientY }) => {
      reference({
  ...
  (0, import_react67.useEffect)(() => {
    if (refs.floating.current) {
      ...
      const parents = (0, import_react68.getOverflowAncestors)(refs.floating.current);
...
var TooltipFloating = factory(
  (_props, ref) => {
    var _b, _c;
    const props = useProps("TooltipFloating", defaultProps2, _props);
    const _a = props, {
      children,
      refProp,
      withinPortal,
    ...
    return /* @__PURE__ */ import_react69.default.createElement(import_react69.default.Fragment, null, /* @__PURE__ */ import_react69.default.createElement(OptionalPortal, __spreadProps(__spreadValues({}, portalProps), { withinPortal }), /* @__PURE__ */ import_react69.default.createElement(
      Box,
      ...
      label
    )), (0, import_react69.cloneElement)(children, __spreadProps(__spreadValues({}, children.props), {
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
    })));
...
var TooltipGroupContext = (0, import_react70.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react70.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  ...
  return /* @__PURE__ */ import_react71.default.createElement(TooltipGroupProvider, { value: true }, /* @__PURE__ */ import_react71.default.createElement(import_react72.FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay } }, children));
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react73.useState)(false);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const { delay: groupDelay, currentId, setCurrentId } = (0, import_react74.useDelayGroupContext)();
  ...
  } = (0, import_react74.useFloating)({
    placement: settings.position,
    open: opened,
    onOpenChange: onChange,
    middleware: [
      (0, import_react74.offset)(settings.offset),
      (0, import_react74.shift)({ padding: 8 }),
      (0, import_react74.flip)(),
      (0, import_react74.arrow)({ element: settings.arrowRef, padding: settings.arrowOffset }),
      ...settings.inline ? [(0, import_react74.inline)()] : []
    ]
  });
  const { getReferenceProps, getFloatingProps } = (0, import_react74.useInteractions)([
    (0, import_react74.useHover)(context, {
      enabled: (_a = settings.events) == null ? void 0 : _a.hover,
      delay: withinGroup ? groupDelay : { open: settings.openDelay, close: settings.closeDelay },
      mouseOnly: !((_b = settings.events) == null ? void 0 : _b.touch)
    }),
    (0, import_react74.useFocus)(context, { enabled: (_c = settings.events) == null ? void 0 : _c.focus, keyboardOnly: true }),
    (0, import_react74.useRole)(context, { role: "tooltip" }),
    // cannot be used with controlled tooltip, page jumps
    (0, import_react74.useDismiss)(context, { enabled: typeof settings.opened === void 0 }),
    (0, import_react74.useDelayGroup)(context, { id: uid })
  ]);
...
var Tooltip = factory((_props, ref) => {
  const props = useProps("Tooltip", defaultProps4, _props);
  const _a = useProps("Tooltip", defaultProps4, props), {
    children,
    position,
    refProp,
    label,
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react75.useRef)(null);
  ...
  return /* @__PURE__ */ import_react75.default.createElement(import_react75.default.Fragment, null, /* @__PURE__ */ import_react75.default.createElement(OptionalPortal, __spreadProps(__spreadValues({}, portalProps), { withinPortal }), /* @__PURE__ */ import_react75.default.createElement(
    Transition,
    ...
    tooltip.getReferenceProps(__spreadValues({
      ...
      [refProp]: targetRef,
      className: (0, import_clsx5.default)(className, children.props.className)
    }, children.props))
  ));
});
