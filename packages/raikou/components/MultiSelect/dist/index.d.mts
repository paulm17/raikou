...
import { BoxProps, StylesApiProps, ElementProps, Factory, RaikouSize, RaikouRadius, PolymorphicFactory, RaikouShadow } from '@raikou/core';
...
interface MultiSelectProps extends BoxProps, __BaseInputProps, ComboboxLikeProps, StylesApiProps<MultiSelectFactory>, ElementProps<"input", "size" | "value" | "defaultValue" | "onChange"> {
