...
type MultiSelectStylesNames = __InputStylesNames | ComboboxLikeStylesNames | "pill" | "pillsList" | "inputField";
interface MultiSelectProps extends BoxProps, __BaseInputProps, ComboboxLikeProps, StylesApiProps<MultiSelectFactory>, ElementProps$1<"input", "size" | "value" | "defaultValue" | "onChange"> {
    ...
    renderOption?: (item: ComboboxLikeRenderOptionInput<ComboboxItem>) => React$2.ReactNode;
...
declare const MultiSelect: _raikou_core.RaikouComponent<{
    props: MultiSelectProps;
    ref: HTMLInputElement;
    stylesNames: MultiSelectStylesNames;
}>;
