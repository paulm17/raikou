...
var MultiSelect = (0, import_core44.factory)((_props, ref) => {
  ...
  const {
    styleProps,
    rest: _b
  } = (0, import_core44.extractStyleProps)(others), _c = _b, { type } = _c, rest = __objRest(_c, ["type"]);
  ...
  const values = _value.map((item, index3) => /* @__PURE__ */ import_react64.default.createElement(
    Pill,
    __spreadValues({
      key: `${item}-${index3}`,
  ...
  return /* @__PURE__ */ import_react64.default.createElement(import_react64.default.Fragment, null, /* @__PURE__ */ import_react64.default.createElement(
    ...
    /* @__PURE__ */ import_react64.default.createElement(Combobox.DropdownTarget, null, /* @__PURE__ */ import_react64.default.createElement(
      ...
      __spreadProps(__spreadValues({}, styleProps), {
        ...
        disabled,
        radius,
        rightSection: rightSection || clearButton || /* @__PURE__ */ import_react64.default.createElement(
          Combobox.Chevron,
          {
            size: size2,
            error,
      ...
      /* @__PURE__ */ import_react64.default.createElement(Pill.Group, __spreadValues({ disabled }, getStyles("pillsList")), values, /* @__PURE__ */ import_react64.default.createElement(Combobox.EventsTarget, null, /* @__PURE__ */ import_react64.default.createElement(
        PillsInput.Field,
