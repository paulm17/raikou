...
function NpmIcon(_a) {
  ...
  return /* @__PURE__ */ React4.createElement(
    ...
    __spreadProps(__spreadValues({}, others), {
      ...
      viewBox: "0 0 256 256",
      xmlns: "http://www.w3.org/2000/svg",
      style: __spreadValues({ width: rem4(size), height: rem4(size) }, style)
    }),
    /* @__PURE__ */ React4.createElement("path", { d: "M0 256V0h256v256z", fill: "#C12127" }),
    /* @__PURE__ */ React4.createElement("path", { d: "M48 48h160v160h-32V80h-48v128H48z", fill: "#FFF" })
  );
}
...
function TypeScriptIcon(_a) {
  ...
  return /* @__PURE__ */ React6.createElement(
    ...
    __spreadValues({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 48 48",
      style: __spreadValues({ width: rem6(size), height: rem6(size) }, style)
    }, others),
    /* @__PURE__ */ React6.createElement("path", { fill: "#1976d2", d: "M6 6h36v36H6z" }),
...
function TypeScriptCircleIcon(_a) {
  ...
  return /* @__PURE__ */ React7.createElement(
    ...
    __spreadValues({
      ...
      viewBox: "0 0 256 256",
      preserveAspectRatio: "xMidYMid",
      style: __spreadValues({ width: rem7(size), height: rem7(size) }, style)
    }, others),
...
import { rem as rem8 } from "@raikou/system";
...
function CssIcon(_a) {
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    __spreadValues({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 48 48",
      style: __spreadValues({ width: rem8(size), height: rem8(size) }, style)
    }, others),
    /* @__PURE__ */ React8.createElement("path", { fill: "#0277BD", d: "M41 5H7l3 34 14 4 14-4 3-34z" }),
    /* @__PURE__ */ React8.createElement("path", { fill: "#039BE5", d: "M24 8v31.9l11.2-3.2L37.7 8z" }),
...
import { rem as rem9 } from "@raikou/system";
function DemoArea({
  withPadding = true,
  centered,
  maxWidth,
  ...
  return /* @__PURE__ */ React9.createElement(
    Box,
    {
      ...
      __vars: {
        ...
        "--demo-max-width": maxWidth ? rem9(maxWidth) : void 0,
        "--demo-min-height": minHeight ? rem9(minHeight) : void 0,
        "--demo-margin-y": maxWidth && centered ? "auto" : void 0
      }
    },
    /* @__PURE__ */ React9.createElement("div", { className: "demoArea-demoInner" }, children)
  );
}
...
function getFileIcon(fileName) {
  if (fileName.endsWith(".ts") || fileName.endsWith(".tsx")) {
    return /* @__PURE__ */ React10.createElement(TypeScriptIcon, { size: 18 });
  }
  if (fileName.endsWith(".css")) {
    return /* @__PURE__ */ React10.createElement(CssIcon, { size: 18 });
  }
  return null;
}
function DemoCode({ code, defaultExpanded = true }) {
  const _code = typeof code === "string" ? { code, fileName: "Demo.tsx", language: "tsx" } : code;
  return /* @__PURE__ */ React10.createElement(React10.Fragment, null, _code && /* @__PURE__ */ React10.createElement(
    CodeHighlightTabs,
    {
      code: _code,
...
function DemoRoot(_a) {
  ...
  return /* @__PURE__ */ React11.createElement("div", __spreadValues({ className: cx("demoRoot-root", className) }, others));
}
...
function CodeDemo({
  ...
  return /* @__PURE__ */ React12.createElement(DemoRoot, null, /* @__PURE__ */ React12.createElement(
    DemoArea,
    {
      withPadding,
      centered,
    ...
    children
  ), /* @__PURE__ */ React12.createElement(DemoCode, { code, defaultExpanded }));
}
...
function DemoColumns({
  ...
  return /* @__PURE__ */ React13.createElement("div", { className: "demoColumns-columns" }, /* @__PURE__ */ React13.createElement(
    DemoArea,
    {
      withPadding,
      maxWidth,
    ...
    children
  ), /* @__PURE__ */ React13.createElement("div", { className: "demoColumns-controls" }, title && /* @__PURE__ */ React13.createElement("div", { className: "demoColumns-header" }, /* @__PURE__ */ React13.createElement(Text, { fw: 500, fz: "sm", mb: 5 }, title), description && /* @__PURE__ */ React13.createElement(Text, { c: "dimmed", fz: 11, lh: 1.45 }, description)), controls));
}
...
function ConfiguratorSegmentedControl(_a) {
  ...
  return /* @__PURE__ */ React15.createElement(Input.Wrapper, __spreadValues({ labelElement: "div", label: getControlLabel(prop) }, others), /* @__PURE__ */ React15.createElement(
    SegmentedControl,
    {
...
import { rem as rem10 } from "@raikou/system";
function ColorWheelIcon() {
  return /* @__PURE__ */ React16.createElement(
    "svg",
    {
      ...
      fill: "none",
      viewBox: "0 0 200 200",
      style: { width: rem10(18), height: rem10(18) }
    },
...
function ConfiguratorColorControl(_a) {
  ...
  const colors = Object.keys(DEFAULT_THEME.colors).filter((color) => color !== "dark").map((color) => /* @__PURE__ */ React17.createElement(
    ColorSwatch,
    {
    ...
    value === color && /* @__PURE__ */ React17.createElement(CheckIcon, { className: "configColor-check" })
  ));
  return /* @__PURE__ */ React17.createElement(Input2.Wrapper, __spreadValues({ labelElement: "div", label: getControlLabel(prop) }, others), /* @__PURE__ */ React17.createElement(Group, { gap: 2, mt: 2, wrap: "wrap" }, colors, /* @__PURE__ */ React17.createElement(Popover, { radius: "md", position: "bottom-end", shadow: "md" }, /* @__PURE__ */ React17.createElement(Popover.Target, null, /* @__PURE__ */ React17.createElement(
    UnstyledButton,
    {
      className: "configColor-colorControl",
      "aria-label": "Pick color"
    },
    /* @__PURE__ */ React17.createElement(ColorWheelIcon, null)
  )), /* @__PURE__ */ React17.createElement(Popover.Dropdown, { p: 8 }, /* @__PURE__ */ React17.createElement(
    ColorPicker,
    {
...
function ConfiguratorSizeControl(_a) {
  ...
  return /* @__PURE__ */ React20.createElement(Input3.Wrapper, __spreadValues({ labelElement: "div", label: getControlLabel(prop) }, others), /* @__PURE__ */ React20.createElement(
    Slider,
    {
      value: _value,
...
function ConfiguratorNumberControl(_a) {
  ...
  return /* @__PURE__ */ React21.createElement(Input4.Wrapper, __spreadValues({ labelElement: "div", label: getControlLabel(prop) }, others), /* @__PURE__ */ React21.createElement(
    Slider2,
    {
      value,
      onChange,
...
function ConfiguratorDemo({
  ...
  return /* @__PURE__ */ React22.createElement(DemoRoot, null, /* @__PURE__ */ React22.createElement(
    DemoColumns,
    {
      controls: /* @__PURE__ */ React22.createElement(Stack, { className: "configDemo-controls", gap: "sm" }, items),
      centered,
      withPadding,
      maxWidth,
      minHeight,
    ...
    React22.cloneElement(children, state)
...
function StylesApiDemo({
  ...
  const controls = selectors.map((selector) => /* @__PURE__ */ React23.createElement(
    UnstyledButton2,
    {
    ...
    /* @__PURE__ */ React23.createElement(Text2, { mb: 2 }, selector),
    /* @__PURE__ */ React23.createElement(Text2, { fz: 11, c: "dimmed" }, data.selectors[selector])
  ));
  const classNamesProp = hovered ? ` classNames={{ ${hovered}: classes.${hovered} }}` : "";
  return /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement("style", { dangerouslySetInnerHTML: { __html: getCss(hovered) } }), /* @__PURE__ */ React23.createElement(DemoRoot, null, /* @__PURE__ */ React23.createElement(
    DemoColumns,
    {
      withPadding,
      maxWidth,
...
function Demo({ data }) {
  ...
  switch (data.type) {
    case "code":
      return /* @__PURE__ */ React24.createElement(CodeDemo, __spreadValues({}, data), /* @__PURE__ */ React24.createElement(Component, null));
    case "configurator":
      return /* @__PURE__ */ React24.createElement(ConfiguratorDemo, __spreadValues({}, data), /* @__PURE__ */ React24.createElement(Component, null));
    case "styles-api":
      return /* @__PURE__ */ React24.createElement(StylesApiDemo, __spreadValues({}, data), /* @__PURE__ */ React24.createElement(Component, null));
    default:
      return null;
  }
}
