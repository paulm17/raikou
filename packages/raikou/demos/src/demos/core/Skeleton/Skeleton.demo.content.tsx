...
import { Group, Button, Text, Skeleton } from "@raikou/server";

const code = `
import { useState } from 'react';
import { Skeleton, Button } from '@raikou/core';
  ...
  return (
    <>
      <Skeleton visible={loading}>
        ...
        <Text>
          Laborum fuga quam voluptas aut pariatur delectus repudiandae commodi
          tempora debitis dolores vero cumque magni cum, deserunt, ad tempore
          consectetur libero molestias similique nemo eum! Dolore maxime
