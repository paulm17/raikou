...
import { Group, Button, Box, Text } from "@raikou/server";

const code = `
import { Group, Button, Box, Text } from '@raikou/core';

function Demo() {
  return (
    <Box style={{ overflow: 'hidden' }}>
      <Box maw={500} p="md" mx="auto" bg="var(--raikou-color-blue-light)">
        <Text size="sm" mb={5}>
...
function Demo() {
  return (
    <Box style={{ overflow: "hidden" }}>
      <Box maw={500} p="md" mx="auto" bg="var(--raikou-color-blue-light)">
        <Text size="sm" mb={5}>
          preventGrowOverflow: true – each child width is always limited to 33%
          of parent width (since there are 3 children)
        </Text>
...
export const preventGrowOverflow: RaikouDemo = {
  type: "code",
  component: Demo,
  code,
};
