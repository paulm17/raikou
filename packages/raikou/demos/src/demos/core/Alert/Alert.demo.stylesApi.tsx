...
import { AlertStylesApi } from "@raikou/styles-api";
import { Alert } from "@raikou/server";
import { IconHeart } from "@tabler/icons-react";

const code = `
import { Alert } from '@raikou/core';
import { IconHeart } from '@tabler/icons-react';
...
function Demo(props: any) {
  return (
    <Alert title="Alert title" icon={<IconHeart />} withCloseButton {...props}>
      ...
      natus veniam quis cupiditate enim architecto mollitia numquam temporibus,
      consectetur nam laboriosam voluptates nemo facilis? Exercitationem aut
