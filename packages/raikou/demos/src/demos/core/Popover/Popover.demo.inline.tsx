...
import { Mark, Text } from "@raikou/server";
import { Popover } from "@raikou/client";

const code = `
import { Popover, Mark, Text } from '@raikou/core';
...
function Demo() {
  return (
    <Text>
      ...
      , you may catch sight of it having an intense fight with Murkrow over
      shiny objects.Ho-Oh’s feathers glow in seven colors depending on the angle
      at which they are struck by light. These feathers are said to bring
      happiness to the bearers. This Pokémon is said to live at the foot of a
      rainbow.
    </Text>
  );
}
