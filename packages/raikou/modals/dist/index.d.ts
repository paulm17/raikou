...
interface LoaderProps extends BoxProps, StylesApiProps<LoaderFactory>, Omit<React$2.ComponentPropsWithoutRef<"svg">, keyof BoxProps> {
...
interface ButtonProps extends BoxProps, StylesApiProps<ButtonFactory> {
    ...
    justify?: React$2.CSSProperties["justifyContent"];
...
interface GroupProps extends BoxProps, StylesApiProps<GroupFactory>, ElementProps<"div"> {
    ...
    align?: React$2.CSSProperties["alignItems"];
...
interface ConfirmModalProps {
    ...
    confirmProps?: ButtonProps & React$2.ComponentPropsWithoutRef<"button">;
...
interface ModalsContextProps {
    ...
    openContextModal: <TKey extends RaikouModal>(modal: TKey, props: OpenContextModal<Parameters<RaikouModals[TKey]>[0]["innerProps"]>) => string;
    closeModal: (id: string, canceled?: boolean) => void;
    closeContextModal: <TKey extends RaikouModal>(id: TKey, canceled?: boolean) => void;
    closeAll: () => void;
}
type RaikouModalsOverride = {};
type RaikouModalsOverwritten = RaikouModalsOverride extends {
    modals: Record<string, React.FC<ContextModalProps<any>>>;
} ? RaikouModalsOverride : {
    modals: Record<string, React.FC<ContextModalProps<any>>>;
};
type RaikouModals = RaikouModalsOverwritten["modals"];
type RaikouModal = keyof RaikouModals;

interface ModalsProviderProps {
    /** Your app */
    children: React$2.ReactNode;
    /** Predefined modals */
    modals?: Record<string, React$2.FC<ContextModalProps<any>>>;
    /** Shared Modal component props, applied for every modal */
    modalProps?: ModalSettings;
    /** Confirm modal labels */
    labels?: ConfirmLabels;
}
declare function ModalsProvider({ children, modalProps, labels, modals, }: ModalsProviderProps): React$2.JSX.Element;
...
declare const closeAllModals: (payload_0?: undefined) => void;
