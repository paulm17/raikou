import type { InputFactory, InputWrapperFactory } from "@raikou/client";
...
export const InputStylesApi: StylesApiData<InputFactory> = {
  ...
  vars: {
    wrapper: {
      ...
      "--input-padding-y":
        "`padding-top` and `padding-bottom` of the input element",
      "--input-radius": "`border-radius` of the input element",
      "--input-left-section-pointer-events":
        "Controls `pointer-events` of the left section",
      "--input-right-section-pointer-events":
        "Controls `pointer-events` of the right section",
    },
  },
