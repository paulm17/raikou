...
export const MonthStylesApi: StylesApiData<MonthFactory> = {
  ...
  modifiers: [
    ...
    },
    {
      ...
      selector: "day",
      condition:
        "Day is outside of current month and `hideOutsideDates` is set",
    },
    {
      modifier: "data-disabled",
      selector: "day",
      condition:
        "Day disabled by one of the props (`excludeDate`, `getDayProps`, etc.)",
    },
...
export const CalendarHeaderStylesApi: StylesApiData<CalendarHeaderFactory> = {
  ...
  vars: {
    calendarHeader: {
      "--dch-control-size":
        "Controls size of the previous/next and level controls",
