import type { AppShellFactory } from "@raikou/server";
...
export const AppShellStylesApi: StylesApiData<AppShellFactory> = {
  ...
  vars: {
    root: {
      "--app-shell-transition-duration":
        "Controls transition duration of all children",
  ...
  modifiers: [
    ...
    },
    {
      ...
      condition:
        "`withBorder` prop is set either on the `AppShell` or on the associated component",
    },
    {
      modifier: "data-grow",
      selector: "section",
