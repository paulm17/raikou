...
export function itSupportsFontsProps<Props>(
  ...
  it(name, () => {
    ...
    expect(ff.querySelector(selector)).toHaveStyle({
      fontFamily: "sans-serif",
    });
    expect(lts.querySelector(selector)).toHaveStyle({
      letterSpacing: "calc(1rem * var(--raikou-scale))",
    });
    ...
    expect(tt.querySelector(selector)).toHaveStyle({
      textTransform: "uppercase",
    });
    expect(td.querySelector(selector)).toHaveStyle({
