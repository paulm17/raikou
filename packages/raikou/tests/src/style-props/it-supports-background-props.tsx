...
export function itSupportsBackgroundProps<Props>(
  ...
  it(name, () => {
    ...
    expect(bgsz.querySelector(selector)).toHaveStyle({
      backgroundSize: "calc(2rem * var(--raikou-scale))",
    });
    expect(bgp.querySelector(selector)).toHaveStyle({
      backgroundPosition: "center",
    });
    expect(bgr.querySelector(selector)).toHaveStyle({
      backgroundRepeat: "repeat",
    });
    expect(bga.querySelector(selector)).toHaveStyle({
