...
describe('@raikou/core/Drawer', () => {
  ...
  it('does not render overlay when withOverlay is false', () => {
    ...
    expect(container.querySelector('.raikou-Drawer-overlay')).not.toBeInTheDocument();

    rerender(<Drawer {...defaultProps} withOverlay />);
    expect(container.querySelector('.raikou-Drawer-overlay')).toBeInTheDocument();
  });
  ...
  it('does not render header if title and withCloseButton are not provided', () => {
    ...
    expect(container.querySelector('.raikou-Drawer-header')).toBeInTheDocument();
    ...
    expect(container.querySelector('.raikou-Drawer-header')).not.toBeInTheDocument();
  });

  it('renders given title', () => {
    const { container } = render(<Drawer {...defaultProps} title="test-title" />);
    expect(container.querySelector('.raikou-Drawer-title')).toHaveTextContent('test-title');
  });
