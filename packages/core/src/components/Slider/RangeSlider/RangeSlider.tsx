...
import { useMove, useUncontrolled } from '@raikou/hooks';
import {
  BoxProps,
  createVarsResolver,
  ElementProps,
...
export const RangeSlider = factory<RangeSliderFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<RangeSliderFactory>({
    ...
    classes: {
      ...
      label: SliderLabelStyle,
      thumb: SliderThumbStyle,
      trackContainer: SliderTrackContainerStyle,
      track: SliderTrackStyle,
      bar: SliderTrackBarStyle,
      markWrapper: SliderMarkWrapperStyle,
      mark: SliderMarkStyle,
      markLabel: SliderMarkLabelStyle,
    },
    classNames,
    className,
    styles,
