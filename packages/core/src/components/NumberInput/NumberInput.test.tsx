...
const clickIncrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.raikou-NumberInput-control[data-direction="up"]')!);

const clickDecrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.raikou-NumberInput-control[data-direction="down"]')!);
...
describe('@raikou/core/NumberInput', () => {
  tests.axe([
  ...
  tests.itSupportsSystemProps<NumberInputProps, __InputStylesNames>({
    ...
    displayName: '@raikou/core/NumberInput',
  ...
  tests.itSupportsInputProps<NumberInputProps>({
    ...
    props: defaultProps,
    focus: false,
    selector: '.raikou-NumberInput-input',
  });
