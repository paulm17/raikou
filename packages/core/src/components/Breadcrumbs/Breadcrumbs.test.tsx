...
describe('@raikou/core/Breadcrumbs', () => {
  ...
  it('renders correct amount of children and separators', () => {
    ...
    expect(container.querySelectorAll('.raikou-Breadcrumbs-breadcrumb')).toHaveLength(3);
    expect(container.querySelectorAll('.raikou-Breadcrumbs-separator')).toHaveLength(2);
  });
