...
export const ColorSwatchRootStyle = css(({ theme }: any) => ({
  '--cs-size': '28px',
  '--cs-radius': '1000px',
...
export const ColorSwatchAlphaOverlayStyle = css({
  ...
  backgroundImage: 'linear-gradient(45deg, var(--alpha-overlay-color) 25%, transparent 25%), linear-gradient(-45deg, var(--alpha-overlay-color) 25%, transparent 25%), linear-gradient(45deg, transparent 75%, var(--alpha-overlay-color) 75%), linear-gradient(-45deg, var(--alpha-overlay-bg) 75%, var(--alpha-overlay-color) 75%)',
});
