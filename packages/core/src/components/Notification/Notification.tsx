...
export const Notification = factory<NotificationFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<NotificationFactory>({
    name: 'Notification',
    classes: {
      root: NotificationRootStyle,
      icon: NotificationIconStyle,
      loader: NotificationLoaderStyle,
      body: NotificationBodyStyle,
      title: NotificationTitleStyle,
      description: NotificationDescriptionStyle,
      closeButton: NotificationCloseButtonStyle,
    },
    props,
    className,
    style,
