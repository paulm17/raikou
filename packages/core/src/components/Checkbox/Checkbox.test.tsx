...
describe('@raikou/core/Checkbox', () => {
  tests.itSupportsSystemProps<CheckboxProps, CheckboxStylesNames>({
    ...
    displayName: '@raikou/core/Checkbox',
    stylesApiSelectors: [
      'root',
      'body',
      'description',
  ...
  it('sets data-checked attribute on the root element if checked prop is true', () => {
    ...
    expect(container.querySelector('.raikou-Checkbox-root')).toHaveAttribute('data-checked');

    rerender(<Checkbox checked={false} onChange={() => {}} />);
    expect(container.querySelector('.raikou-Checkbox-root')).not.toHaveAttribute('data-checked');
  });
