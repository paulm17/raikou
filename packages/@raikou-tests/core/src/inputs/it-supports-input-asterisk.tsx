...
export function itSupportsInputAsterisk<Props>(
  ...
  it(name, () => {
    ...
    expect(container.querySelector('.raikou-InputWrapper-required')).not.toBeInTheDocument();
    ...
    expect(container.querySelector('.raikou-InputWrapper-required')).toBeInTheDocument();
