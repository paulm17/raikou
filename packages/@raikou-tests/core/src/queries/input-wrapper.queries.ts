export const inputWrapperQueries = {
  getLabel: (container: HTMLElement) => container.querySelector('.raikou-InputWrapper-label')!,
  getError: (container: HTMLElement) => container.querySelector('.raikou-InputWrapper-error')!,
