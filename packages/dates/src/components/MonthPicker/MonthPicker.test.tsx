...
describe('@raikou/dates/MonthPicker', () => {
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('.raikou-MonthPicker-monthsList')).toBeInTheDocument();
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<MonthPicker {...defaultProps} __staticSelector="Calendar" />);
    expect(container.querySelector('.raikou-Calendar-monthsList')).toBeInTheDocument();
  });
});
