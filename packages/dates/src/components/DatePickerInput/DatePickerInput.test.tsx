...
import { inputDefaultProps, inputStylesApiSelectors, render, tests } from '@raikou-tests/core';
import { clickControl, clickInput, datesTests, expectValue } from '@raikou-tests/dates';
...
describe('@raikou/dates/DatePickerInput', () => {
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('table button')).toHaveClass('raikou-DatePickerInput-day');
  });
