...
describe('@raikou/dates/YearPicker', () => {
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('.raikou-YearPicker-yearsList')).toBeInTheDocument();
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<YearPicker {...defaultProps} __staticSelector="Calendar" />);
    expect(container.querySelector('.raikou-Calendar-yearsList')).toBeInTheDocument();
  });
