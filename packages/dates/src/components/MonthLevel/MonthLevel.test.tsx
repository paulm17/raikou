...
describe('@raikou/dates/MonthLevel', () => {
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('table td button')).toHaveClass('raikou-MonthLevel-day');
  ...
  it('supports custom __staticSelector', () => {
    ...
    expect(container.querySelector('table td button')).toHaveClass('raikou-Calendar-day');
    expect(screen.getByLabelText('level-control')).toHaveClass(
