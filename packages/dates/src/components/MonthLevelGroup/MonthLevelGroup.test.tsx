...
describe('@raikou/dates/MonthLevelGroup', () => {
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('table button')).toHaveClass('raikou-MonthLevelGroup-day');
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<MonthLevelGroup {...defaultProps} __staticSelector="Calendar" />);
    expect(container.querySelector('table button')).toHaveClass('raikou-Calendar-day');
  });
});
