...
export const LoaderPropagate1Style = css({
  ...
  animation:
    "propagate-loader-1 calc(1.5s / var(--propagate-speed-multiplier)) infinite",
});

export const LoaderPropagate2Style = css({
  ...LoaderPropagateStyle,
  animation:
    "propagate-loader-2 calc(1.5s / var(--propagate-speed-multiplier)) infinite",
});

export const LoaderPropagate3Style = css({
  ...LoaderPropagateStyle,
  animation:
    "propagate-loader-3 calc(1.5s / var(--propagate-speed-multiplier)) infinite",
});

export const LoaderPropagate4Style = css({
  ...LoaderPropagateStyle,
  animation:
    "propagate-loader-4 calc(1.5s / var(--propagate-speed-multiplier)) infinite",
});

export const LoaderPropagate5Style = css({
  ...LoaderPropagateStyle,
  animation:
    "propagate-loader-5 calc(1.5s / var(--propagate-speed-multiplier)) infinite",
});

export const LoaderPropagate6Style = css({
  ...LoaderPropagateStyle,
  animation:
    "propagate-loader-6 calc(1.5s / var(--propagate-speed-multiplier)) infinite",
});
