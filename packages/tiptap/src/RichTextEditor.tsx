...
import { RichTextEditorContentStyle, RichTextEditorControlStyle, RichTextEditorControlsGroupStyle, RichTextEditorLinkEditorSaveStyle, RichTextEditorLinkEditorStyle, RichTextEditorRootStyle, RichTextEditorToolbarStyle, RichTextEditorLinkEditorExternalControlStyle, RichTextEditorLinkEditorInputStyle, RichTextEditorLinkEditorDropdownStyle, RichTextEditorTypographyStylesProviderStyle } from './RichTextEditor.css';
...
export const RichTextEditor = factory<RichTextEditorFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<RichTextEditorFactory>({
    name: 'RichTextEditor',
    classes: {
      root: RichTextEditorRootStyle,
      typographyStylesProvider: RichTextEditorTypographyStylesProviderStyle,
      content: RichTextEditorContentStyle,
      linkEditorDropdown: RichTextEditorLinkEditorDropdownStyle,
      control: RichTextEditorControlStyle,
      controlsGroup: RichTextEditorControlsGroupStyle,
      linkEditor: RichTextEditorLinkEditorStyle,
      linkEditorInput: RichTextEditorLinkEditorInputStyle,  
      linkEditorExternalControl: RichTextEditorLinkEditorExternalControlStyle,
      linkEditorSave: RichTextEditorLinkEditorSaveStyle,
      toolbar: RichTextEditorToolbarStyle,
    },
    props,
    className,
    style,
