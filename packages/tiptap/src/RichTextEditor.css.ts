...
export const RichTextEditorRootStyle = css(({ theme }: any) => ({
  position: 'relative',
  border: '1px solid',
...
export const RichTextEditorContentStyle = css(({ theme }: any) => ({
...
export const RichTextEditorControlStyle = css(({ theme }: any) => ({
  "&&": {
    minWidth: '26px',
    height: '26px',
    display: 'flex',
...
export const RichTextEditorLinkEditorExternalControlStyle = css(({ theme }: any) => ({
  border: '1px solid',
...
export const RichTextEditorToolbarStyle = css(({ theme }: any) => ({
  display: 'flex',
  alignItems: 'center',
  flexWrap: 'wrap',
...
export const RichTextEditorTaskListStyle = css(({ theme }: any) => ({
  listStyleType: 'none',
  padding: 0,
