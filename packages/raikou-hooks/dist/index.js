...
function useCounter(initialValue = 0, options) {
  ...
  const [count, setCount] = (0, import_react6.useState)(
...
function useDocumentVisibility() {
  const [documentVisibility, setDocumentVisibility] = (0,
  import_react10.useState)("visible");
...
function useFocusReturn({ opened, shouldReturnFocus = true }) {
  ...
  const returnFocus = () => {
    ...
    if (
      ...
      (_a = lastActiveElement.current) == null
        ? void 0
...
function createAriaHider(containerNode, selector = "body > :not(script)") {
  const id = randomId();
  const rootNodes = Array.from(document.querySelectorAll(selector)).map(
    (node) => {
      var _a;
      if (
        ((_a = node == null ? void 0 : node.shadowRoot) == null
          ? void 0
          : _a.contains(containerNode)) ||
...
function createStorage(type, hookName) {
  const eventName =
    type === "localStorage" ? "raikou-local-storage" : "raikou-session-storage";
  ...
  (0, import_react24.useEffect)(() => {
    ...
    const startScrubbing = () => {
      if (!isSliding.current && mounted.current) {
        ...
        typeof (handlers == null ? void 0 : handlers.onScrubStart) ===
    ...
    const stopScrubbing = () => {
      if (isSliding.current && mounted.current) {
        ...
        unbindEvents();
        setTimeout(() => {
          typeof (handlers == null ? void 0 : handlers.onScrubEnd) ===
            "function" && handlers.onScrubEnd();
        }, 0);
      }
    };
    ...
    (_a = ref.current) == null
      ? void 0
      : _a.addEventListener("mousedown", onMouseDown);
    (_b = ref.current) == null
      ? void 0
      : _b.addEventListener("touchstart", onTouchStart, { passive: false });
    return () => {
      if (ref.current) {
...
function useUncontrolled({
  ...
  import_react25.useState)(defaultValue !== void 0 ? defaultValue : finalValue);
...
async function enterFullScreen(element) {
  ...
  return (
    ((_a = _element.requestFullscreen) == null ? void 0 : _a.call(_element)) ||
    ((_b = _element.msRequestFullscreen) == null
      ? void 0
      : _b.call(_element)) ||
    ((_c = _element.webkitEnterFullscreen) == null
      ? void 0
      : _c.call(_element)) ||
    ((_d = _element.webkitRequestFullscreen) == null
      ? void 0
      : _d.call(_element)) ||
    ((_e = _element.mozRequestFullscreen) == null ? void 0 : _e.call(_element))
  );
}
...
function useHover() {
  ...
  const onMouseEnter = (0, import_react40.useCallback)(
    () => setHovered(true),
    []
  );
  const onMouseLeave = (0, import_react40.useCallback)(
    () => setHovered(false),
    []
  );
  (0, import_react40.useEffect)(() => {
    if (ref.current) {
      ...
      return () => {
        ...
        (_a = ref.current) == null
          ? void 0
          : _a.removeEventListener("mouseenter", onMouseEnter);
        (_b = ref.current) == null
          ? void 0
          : _b.removeEventListener("mouseleave", onMouseLeave);
      };
    }
    return void 0;
  }, []);
    ...
    if (ref.current) {
      ...
      return () => {
        ...
        return (_a = ref.current) == null
          ? void 0
          : _a.removeEventListener(type, listener, options);
      };
    }
    return void 0;
  }, [listener, options]);
  ...
  (0, import_react47.useEffect)(() => {
    if (ref.current) {
      ...
      return () => {
        ...
        (_a = ref.current) == null
          ? void 0
          : _a.removeEventListener("focusin", handleFocusIn);
        (_b = ref.current) == null
          ? void 0
          : _b.removeEventListener("focusout", handleFocusOut);
      };
    }
    return void 0;
...
function useFavicon(url) {
  ...
  useIsomorphicEffect(() => {
    ...
    if (!link.current) {
      ...
      existingElements.forEach((element2) =>
...
var isReleased = (current, previous, fixedAt) =>
