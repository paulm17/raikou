...
export const LoaderCubeSide1Style = css({
  ...
  transform: 'rotateX(0deg) rotateY(0deg) translateZ(calc(var(--cube-size) / 2))',
});

export const LoaderCubeSide2Style = css({
  ...side,
  backgroundColor: 'var(--cube-color)',
  transform: 'rotateX(0deg) rotateY(180deg) translateZ(calc(var(--cube-size) / 2))',
});

export const LoaderCubeSide3Style = css({
  ...side,
  backgroundColor: 'darken(var(--cube-color), 0.5)',
  transform: 'rotateX(-90deg) rotateY(0deg) translateZ(calc(var(--cube-size) / 2))',
});
...
export const LoaderCubeSide5Style = css({
  ...side,
  backgroundColor: 'darken(var(--cube-color), 0.5)',
  transform: 'rotateX(0deg) rotateY(90deg) translateZ(calc(var(--cube-size) / 2))',
});
