...
// import { createTheme, RaikouProvider } from '@raikou/core';
import { defaultLoaders, Loader } from './HorizontalBar';
...
const RingLoader: RaikouLoaderComponent = forwardRef(({ style, ...others }, ref) => (
  <svg
    {...others}
    ref={ref}
    style={{
