...
import { LoaderPuff1Style, LoaderPuff2Style, LoaderPuffLoaderStyle } from './Puff.css';
...
export interface PuffProps extends BoxProps, StylesApiProps<PuffFactory>, ElementProps<'span'> {
