...
export const LoaderSpiralCubeSide1Style = css({
  ...
  transform: 'rotateX(0deg) rotateY(0deg) translateZ(calc(var(--spiral-size) / 8))',
});

export const LoaderSpiralCubeSide2Style = css({
  ...cubeSide,
  backgroundColor: 'var(--spiral-color)',
  transform: 'rotateX(0deg) rotateY(180deg) translateZ(calc(var(--spiral-size) / 8))',
});

export const LoaderSpiralCubeSide3Style = css({
  ...cubeSide,
  backgroundColor: 'darken(var(--spiral-color), 0.5)',
  transform: 'rotateX(-90deg) rotateY(0deg) translateZ(calc(var(--spiral-size) / 8))',
});
