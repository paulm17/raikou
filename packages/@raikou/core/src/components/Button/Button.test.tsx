...
describe('@raikou/core/Button', () => {
  ...
  tests.itSupportsSystemProps<ButtonProps, ButtonStylesNames>({
    ...
    displayName: '@raikou/core/Button',
  ...
  it('renders given left section', () => {
    ...
    expect(
      container.querySelector('.raikou-Button-section[data-position="left"]')
  ...
  it('renders given right section', () => {
    ...
    expect(
      container.querySelector('.raikou-Button-section[data-position="right"]')
