...
const data: TreeNodeData[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: '@raikou',
        value: 'node_modules/@raikou',
        children: [
          { label: 'core', value: 'node_modules/@raikou/core' },
          { label: 'hooks', value: 'node_modules/@raikou/hooks' },
          { label: 'form', value: 'node_modules/@raikou/form' },
        ],
      },
    ],
  },
