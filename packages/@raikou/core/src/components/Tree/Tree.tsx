...
import { useClickOutside, useMergedRef } from '@raikou/hooks';
import {
  Box,
  BoxProps,
  createVarsResolver,
...
import { TreeLabelStyle, TreeNodeStyle, TreeRootStyle, TreeSubtreeStyle } from './Tree.css';
...
export const Tree = factory<TreeFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<TreeFactory>({
    ...
    classes: {
      root: TreeRootStyle,
      subtree: TreeSubtreeStyle,
      node: TreeNodeStyle,
      label: TreeLabelStyle,
    },
    props,
    className,
    style,
...
Tree.displayName = '@raikou/core/Tree';
