import { normalizeRadialValue, useMergedRef, useRadialMove, useUncontrolled } from '@raikou/hooks';
import {
  Box,
  BoxProps,
  createVarsResolver,
...
import {
  AngleSliderLabelStyle,
  AngleSliderMarksStyle,
  AngleSliderMarkStyle,
  AngleSliderRootStyle,
  AngleSliderThumbStyle,
} from './AngleSlider.css';
...
export const AngleSlider = factory<AngleSliderFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<AngleSliderFactory>({
    name: 'AngleSlider',
    classes: {
      root: AngleSliderRootStyle,
      marks: AngleSliderMarksStyle,
      mark: AngleSliderMarkStyle,
      thumb: AngleSliderThumbStyle,
      label: AngleSliderLabelStyle,
    },
    props,
    className,
    style,
...
AngleSlider.displayName = '@raikou/core/AngleSlider';
