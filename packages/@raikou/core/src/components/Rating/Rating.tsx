...
import { RatingInputStyle, RatingLabelStyle, RatingRootStyle, RatingStarSymbolStyle, RatingSymbolBodyStyle, RatingSymbolGroupStyle } from './Rating.css';
...
export const Rating = factory<RatingFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<RatingFactory>({
    name: 'Rating',
    classes: {
      root: RatingRootStyle,
      starSymbol: RatingStarSymbolStyle,
      input: RatingInputStyle,
      label: RatingLabelStyle,
      symbolBody: RatingSymbolBodyStyle,
      symbolGroup: RatingSymbolGroupStyle,
    },
    props,
    className,
    style,
