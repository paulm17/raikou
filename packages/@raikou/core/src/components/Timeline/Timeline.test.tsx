...
describe('@raikou/core/Timeline', () => {
  tests.itSupportsSystemProps<TimelineProps, TimelineStylesNames>({
    ...
    displayName: '@raikou/core/Timeline',
  ...
  it('handles active item correctly', () => {
    ...
    expect(container.querySelectorAll('.raikou-Timeline-item[data-active]')).toHaveLength(2);
    expect(container.querySelectorAll('.raikou-Timeline-item[data-line-active]')).toHaveLength(1);

    rerender(<Timeline {...defaultProps} active={2} />);
    expect(container.querySelectorAll('.raikou-Timeline-item[data-active]')).toHaveLength(3);
    expect(container.querySelectorAll('.raikou-Timeline-item[data-line-active]')).toHaveLength(2);
  });
