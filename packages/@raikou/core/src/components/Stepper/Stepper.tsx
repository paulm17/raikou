...
export const Stepper = factory<StepperFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<StepperFactory>({
    name: 'Stepper',
    classes: {
      root: StepperRootStyle,
      separator: StepperSeparatorStyle,
      steps: StepperStepsStyle,
      content: StepperContentStyle,
      step: StepperStepStyle,
      verticalSeparator: StepperVerticalSeparatorStyle,
      stepWrapper: StepperStepWrapperStyle,
      stepIcon: StepperStepIconStyle,
      stepCompletedIcon: StepperStepCompletedIconStyle,
      stepBody: StepperStepBodyStyle,
      stepLabel: StepperStepLabelStyle,
      stepDescription: StepperStepDescriptionStyle,
    },
    props,
    className,
    style,
