...
export const ColorPicker = factory<ColorPickerFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<ColorPickerFactory>({
    ...
    props,
    classes: {
      wrapper: ColorPickerRootStyle,
      preview: ColorPickerPreviewStyle,
      body: ColorPickerBodyStyle,
      sliders: ColorPickerSlidersStyle,
      slider: ColorPickerSliderStyle,
      sliderOverlay: ColorPickerSliderOverlayStyle,
      thumb: ColorPickerThumbStyle,
      saturation: ColorPickerSaturationStyle,
      saturationOverlay: ColorPickerSaturationOverlayStyle,
      swatches: ColorPickerSwatchesStyle,
      swatch: ColorPickerSwatchStyle,
    },
    className,
    style,
    classNames,
