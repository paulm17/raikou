...
export const NavLink = polymorphicFactory<NavLinkFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<NavLinkFactory>({
    ...
    props,
    classes: {
      root: NavLinkRootStyle,
      section: NavLinkSectionStyle,
      body: NavLinkBodyStyle,
      label: NavLinkLabelStyle,
      description: NavLinkDescriptionStyle,
      chevron: NavLinkChevronStyle,
      children: NavLinkChildrenStyle,
    },
    className,
    style,
    classNames,
