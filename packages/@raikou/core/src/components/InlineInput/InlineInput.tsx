...
export const InlineInput = forwardRef<HTMLDivElement, InlineInputProps>(
  (
    ...
    const getStyles = useStyles<InlineInputFactory>({
      ...
      style,
      classes: {
        root: InlineInputRootStyle,
        body: InlineInputBodyStyle,
        labelWrapper: InlineInputLabelWrapperStyle,
        label: InlineInputLabelStyle,
        description: InlineInputDescriptionStyle,
        error: InlineInputErrorStyle,
      },
      classNames,
      styles,
      unstyled,
