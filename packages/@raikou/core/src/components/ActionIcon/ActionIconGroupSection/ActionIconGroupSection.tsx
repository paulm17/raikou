...
import { ActionIconGroupSectionStyle } from '../ActionIcon.css';
...
export const ActionIconGroupSection = factory<ActionIconGroupSectionFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<ActionIconGroupSectionFactory>({
    ...
    props,
    classes: {
      groupSection: ActionIconGroupSectionStyle
    },
    className,
    style,
    classNames,
...
ActionIconGroupSection.displayName = '@raikou/core/ActionIconGroupSection';
