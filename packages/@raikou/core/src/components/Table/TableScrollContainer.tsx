...
import { TableScrollContainerInnerStyle, TableScrollContainerStyle } from './Table.css';
...
export const TableScrollContainer = factory<TableScrollContainerFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<TableScrollContainerFactory>({
    ...
    classes: {
      scrollContainer: TableScrollContainerStyle,
      scrollContainerInner: TableScrollContainerInnerStyle,
    },
    props,
    className,
    style,
