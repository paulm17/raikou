...
import { AvatarImageStyle, AvatarPlaceholderStyle, AvatarRootStyle } from './Avatar.css';
...
export interface AvatarProps extends BoxProps, StylesApiProps<AvatarFactory> {
  ...
  /** An array of colors that can be used for autogenerated initials. By default, all default Raikou colors can be used except gray and dark. */
  allowedInitialsColors?: RaikouColor[];
}
...
export const Avatar = polymorphicFactory<AvatarFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<AvatarFactory>({
    ...
    classes: {
      ...
      placeholder: AvatarPlaceholderStyle,
