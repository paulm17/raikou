...
describe('@raikou/core/Avatar', () => {
  ...
  tests.itSupportsSystemProps<AvatarProps, AvatarStylesNames>({
    ...
    displayName: '@raikou/core/Avatar',
  ...
  it('renders placeholder if src was not set', () => {
    ...
    expect(container.querySelector('.raikou-Avatar-placeholder')).toBeInTheDocument();

    rerender(<Avatar src="image.png" />);
    expect(container.querySelector('.raikou-Avatar-placeholder')).not.toBeInTheDocument();
