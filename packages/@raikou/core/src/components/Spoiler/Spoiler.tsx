import { useElementSize, useId, useUncontrolled } from '@raikou/hooks';
import {
  Box,
  BoxProps,
  createVarsResolver,
...
import { SpoilerContentStyle, SpoilerControlStyle, SpoilerRootStyle } from './Spoiler.css';
...
export const Spoiler = factory<SpoilerFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<SpoilerFactory>({
    name: 'Spoiler',
    classes: {
      root: SpoilerRootStyle,
      content: SpoilerContentStyle,
      control: SpoilerControlStyle,
    },
    props,
    className,
    style,
