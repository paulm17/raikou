import { createContextContainer, patchConsoleError, render, tests } from '@raikou-tests/core';
...
describe('@raikou/core/ComboboxDropdownTarget', () => {
  ...
  it('has correct displayName', () => {
    expect(ComboboxDropdownTarget.displayName).toBe('@raikou/core/ComboboxDropdownTarget');
  });
});
