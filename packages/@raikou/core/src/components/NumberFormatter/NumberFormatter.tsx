...
import { ExtendComponent, Factory, RaikouThemeComponent, useProps } from '../../core';
...
const extendNumberFormatter = (c: ExtendComponent<NumberFormatterFactory>): RaikouThemeComponent =>
  c;
