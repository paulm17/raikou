...
import { useDidUpdate, useEyeDropper, useUncontrolled } from '@raikou/hooks';
import {
  BoxProps,
  createVarsResolver,
  ElementProps,
...
export const ColorInput = factory<ColorInputFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<ColorInputFactory>({
    ...
    props,
    classes: {
      eyeDropperIcon: ColorInputEyeDropperIconStyle,
      dropdown: ColorInputDropdownStyle,
      colorPreview: ColorInputPreviewStyle,
    },
    classNames,
    styles,
    unstyled,
    ...
    >
      ...
      >
        ...
        <Popover.Dropdown
          ...
          className={ColorInputDropdownStyle}
        >
          <ColorPicker
            __staticSelector="ColorInput"
            value={_value}
