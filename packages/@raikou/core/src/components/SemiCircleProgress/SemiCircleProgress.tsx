...
export const SemiCircleProgress = factory<SemiCircleProgressFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<SemiCircleProgressFactory>({
    ...
    classes: {
      root: SemiCircleProgressRootStyle,
      svg: SemiCircleProgressSvgStyle,
      filledSegment: SemiCircleProgressFilledSegmentStyle,
      label: SemiCircleProgressLabelStyle,
    },
    props,
    className,
    style,
...
SemiCircleProgress.displayName = '@raikou/core/SemiCircleProgress';
