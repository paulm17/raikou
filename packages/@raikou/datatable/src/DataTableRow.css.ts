...
export const dataTableRowStyle = css(({ theme }) => ({
  ...theme.applyStyles('light', {
    ...
    '--raikou-datatable-row-background-color': 'var(--raikou-datatable-row-color-dark)',
  }),
  ...theme.applyStyles('dark', {
    '--raikou-datatable-row-color': 'var(--raikou-datatable-row-background-color-light)',
    '--raikou-datatable-row-background-color': 'var(--raikou-datatable-row-background-color-dark))',
  }),
