import { useLocalStorage } from "@raikou/hooks";
 ...
 * @see https://icflorescu.github.io/raikou-datatable/examples/column-dragging-and-toggling/
 */
export const useDataTableColumns = <T>({
  ...
  function useAlignColumnsToggle() {
    ...
    >({
      ...
      defaultValue: key
        ? (defaultColumnsToggle as DataTableColumnToggle[])
        : undefined,
      getInitialValueInEffect,
    });
    ...
    function setColumnsToggle(
      toggle:
        | DataTableColumnToggle[]
        | ((prev: DataTableColumnToggle[]) => DataTableColumnToggle[]),
    ) {
      if (key) {
    ...
    return [
      alignColumnsToggle(columnsToggle, columns),
      setColumnsToggle,
    ] as const;
  }
  ...
  function useAlignColumnsWidth() {
    ...
    >({
      ...
      defaultValue: key
        ? (defaultColumnsWidth as DataTableColumnWidth[])
        : undefined,
      getInitialValueInEffect,
    });
    ...
    function setColumnsWidth(
      width:
        | DataTableColumnWidth[]
        | ((prev: DataTableColumnWidth[]) => DataTableColumnWidth[]),
    ) {
      if (key) {
