...
describe('@raikou/dates/DateInput', () => {
  tests.axe([
  ...
  tests.itSupportsSystemProps<DateInputProps, __InputStylesNames>({
    ...
    displayName: '@raikou/dates/DateInput',
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('[data-dates-input]')).toHaveClass('raikou-DateInput-input');

    expect(container.querySelector('table button')!).toHaveClass('raikou-DateInput-day');
  });
});
