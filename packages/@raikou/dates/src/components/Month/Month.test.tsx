...
describe('@raikou/dates/Month', () => {
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('thead tr')).toHaveClass('raikou-Month-weekdaysRow');
    expect(container.querySelector('tbody tr td button')).toHaveClass('raikou-Month-day');
  });

  it('supports __staticSelector', () => {
    const { container } = render(<Month {...defaultProps} __staticSelector="Calendar" />);
    expect(container.querySelector('table')).toHaveClass('raikou-Calendar-month');
    expect(container.querySelector('thead tr')).toHaveClass('raikou-Calendar-weekdaysRow');
    expect(container.querySelector('tbody tr td button')).toHaveClass('raikou-Calendar-day');
  });
