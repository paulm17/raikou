...
describe('@raikou/dates/DatePicker', () => {
  tests.itSupportsSystemProps<DatePickerProps, DatePickerStylesNames>({
    ...
    displayName: '@raikou/dates/DatePicker',
    stylesApiSelectors: [
      'day',
      'month',
      'monthCell',
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('.raikou-DatePicker-month')).toBeInTheDocument();
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<DatePicker {...defaultProps} __staticSelector="Calendar" />);
    expect(container.querySelector('.raikou-Calendar-month')).toBeInTheDocument();
  });
});
