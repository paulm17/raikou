...
import { RadialBarChartRootStyle, RadialBarChartTooltipStyle } from './RadialBarChart.css';
...
export const RadialBarChart = factory<RadialBarChartFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<RadialBarChartFactory>({
    name: 'RadialBarChart',
    classes: {
      root: RadialBarChartRootStyle,
      tooltip: RadialBarChartTooltipStyle,
    },
    props,
    className,
    style,
...
RadialBarChart.displayName = '@raikou/core/RadialBarChart';
