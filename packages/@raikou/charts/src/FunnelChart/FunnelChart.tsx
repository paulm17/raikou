...
import { FunnelChartRootStyle } from './FunnelChart.css';
      ...
      <ResponsiveContainer>
        <RechartsFunnelChart {...funnelChartProps}>
          <Funnel
            ...
            stroke="var(--chart-stroke-color, var(--raikou-color-body))"
              ...
              <LabelList
                ...
                fill={
                  labelsPosition === 'inside'
                    ? 'var(--chart-labels-color, var(--raikou-color-white))'
                    : 'var(--chart-labels-color, var(--raikou-color-dimmed))'
                }
                stroke="none"
...
FunnelChart.displayName = '@raikou/charts/FunnelChart';
