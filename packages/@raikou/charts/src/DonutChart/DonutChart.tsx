...
import { DonutChartLabelStyle, DonutChartRootStyle } from './DonutChart.css';
...
export const DonutChart = factory<DonutChartFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<DonutChartFactory>({
    name: 'DonutChart',
    classes: {
      root: DonutChartRootStyle,
      label: DonutChartLabelStyle,
    },
    props,
    className,
    style,
...
DonutChart.displayName = '@raikou/charts/DonutChart';
