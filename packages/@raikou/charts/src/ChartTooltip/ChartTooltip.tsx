...
export const ChartTooltip = factory<ChartTooltipFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<ChartTooltipFactory>({
    ...
    classes: {
      ...
      tooltipItem: ChartTooltipItemStyle,
      tooltipItemBody: ChartTooltipItemBodyStyle,
      tooltipItemColor: ChartTooltipItemColorStyle,
      tooltipItemName: ChartTooltipItemNameStyle,
      tooltipItemData: ChartTooltipItemDataStyle,
      tooltipLabel: ChartTooltipLabelStyle,
      tooltipBody: ChartTooltipBodyStyle,
    },
    props,
    className,
    style,
...
ChartTooltip.displayName = '@raikou/charts/ChartTooltip';
