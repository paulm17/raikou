...
describe('@raikou/charts/LineChart', () => {
  beforeAll(() => {
    patchConsoleWarn();
  });
  ...
  tests.itSupportsSystemProps<LineChartProps, LineChartStylesNames>({
    ...
    displayName: '@raikou/charts/LineChart',
  ...
  it('renders LineChart legend with nested series name', async () => {
    ...
    const legendElementList = container.querySelectorAll('.raikou-ChartLegend-legendItemName');
