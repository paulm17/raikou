...
import { NotificationsNotificationStyle, NotificationsRootStyle } from './Notifications.css';
...
export const Notifications = factory<NotificationsFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<NotificationsFactory>({
    name: 'Notifications',
    classes: {
      root: NotificationsRootStyle,
      notification: NotificationsNotificationStyle,
    },
    props,
    className,
    style,
