...
export const SpotlightActionStyle = css(({ theme }) => ({
  ...
  "&:_where([data-selected])": {
    ...
    "--action-description-color":
      "var(--raikou-primary-color-contrast, var(--raikou-color-white))",
...
export const SpotlightActionDescriptionStyle = css(({ theme }) => ({
  display: "block",
...
export const SpotlightEmptyStyle = css(({ theme }) => ({
