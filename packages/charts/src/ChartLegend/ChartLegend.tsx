...
export const ChartLegend = factory<ChartLegendFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<ChartLegendFactory>({
    name: 'ChartLegend',
    classes: {
      legendItem: ChartLegendItemStyle,
      legendItemColor: ChartLegendItemColorStyle,
      legendItemName: ChartLegendItemNameStyle,
...
ChartLegend.displayName = '@raikou/charts/ChartLegend';
