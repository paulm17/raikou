...
import { RadarChartContainerStyle, RadarChartRootStyle } from './RadarChart.css';
...
export const RadarChart = factory<RadarChartFactory>((_props, ref) => {
  ...
  const getStyles = useStyles<RadarChartFactory>({
    name: 'RadarChart',
    classes: {
      root: RadarChartRootStyle,
      container: RadarChartContainerStyle,
    },
    props,
    className,
    style,
...
RadarChart.displayName = '@raikou/charts/RadarChart';
